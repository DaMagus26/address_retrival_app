...
class MorphClass:
    ...
    def __and__(self : 'MorphClass', arg2 : 'MorphClass') -> 'MorphClass':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphClass._new284(((val1) & (val2)))
    ...
    @staticmethod
    def _new275(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_undefined = _arg1
        return res
    
    @staticmethod
    def _new276(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_noun = _arg1
        return res
    
    @staticmethod
    def _new277(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_pronoun = _arg1
        return res
    
    @staticmethod
    def _new278(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_personal_pronoun = _arg1
        return res
    
    @staticmethod
    def _new279(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_verb = _arg1
        return res
    
    @staticmethod
    def _new280(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adjective = _arg1
        return res
    
    @staticmethod
    def _new281(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adverb = _arg1
        return res
    
    @staticmethod
    def _new282(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_preposition = _arg1
        return res
    
    @staticmethod
    def _new283(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_conjunction = _arg1
        return res
    
    @staticmethod
    def _new284(_arg1 : int) -> 'MorphClass':
        res = MorphClass()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new2757(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
    ...
    def _static_ctor():
        ...
        MorphClass.UNDEFINED = MorphClass._new275(True)
        MorphClass.NOUN = MorphClass._new276(True)
        MorphClass.PRONOUN = MorphClass._new277(True)
        MorphClass.PERSONAL_PRONOUN = MorphClass._new278(True)
        MorphClass.VERB = MorphClass._new279(True)
        MorphClass.ADJECTIVE = MorphClass._new280(True)
        MorphClass.ADVERB = MorphClass._new281(True)
        MorphClass.PREPOSITION = MorphClass._new282(True)
        MorphClass.CONJUNCTION = MorphClass._new283(True)
