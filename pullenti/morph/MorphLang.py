...
class MorphLang:
    ...
    def __and__(self : 'MorphLang', arg2 : 'MorphLang') -> 'MorphLang':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphLang._new287(((val1) & (val2)))
    ...
    @staticmethod
    def _new287(_arg1 : int) -> 'MorphLang':
        res = MorphLang()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new289(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ru = _arg1
        return res
    
    @staticmethod
    def _new290(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ua = _arg1
        return res
    
    @staticmethod
    def _new291(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_by = _arg1
        return res
    
    @staticmethod
    def _new292(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_en = _arg1
        return res
    
    @staticmethod
    def _new293(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_it = _arg1
        return res
    
    @staticmethod
    def _new294(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_kz = _arg1
        return res
    ...
    def _static_ctor():
        ...
        MorphLang.RU = MorphLang._new289(True)
        MorphLang.UA = MorphLang._new290(True)
        MorphLang.BY = MorphLang._new291(True)
        MorphLang.EN = MorphLang._new292(True)
        MorphLang.IT = MorphLang._new293(True)
        MorphLang.KZ = MorphLang._new294(True)
