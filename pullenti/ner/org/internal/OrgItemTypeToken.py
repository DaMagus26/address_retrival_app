...
class OrgItemTypeToken(MetaToken):
    ...
    def __try_attach_int(t : 'Token', can_be_first_letter_lower : bool) -> 'OrgItemTypeToken':
        ...
        if (term == "ВЧ"): 
            ...
            if (tt1 is not None and tt1.is_value("ПП", None)): 
                res = OrgItemTypeToken._new1927(t, tt1, 3)
        ...
        if ((term == "ТС" and t.chars.is_all_upper and (isinstance(t.previous, TextToken))) and (t.whitespaces_before_count < 3)): 
            ...
            if (t.previous.is_value("КОДЕКС", None)): 
                ...
                ok = True
            if (ok): 
                res = OrgItemTypeToken._new1928(t, t, "союз", "ТАМОЖЕННЫЙ СОЮЗ", 4)
                return res
        if (term == "КБ"): 
            cou = 0
            ok = False
        ...
        if (((say or tt.is_value("ОБЛОЖКА", "ОБКЛАДИНКА") or tt.is_value("РЕДАКТОР", None)) or tt.is_value("КОРРЕСПОНДЕНТ", "КОРЕСПОНДЕНТ") or tt.is_value("ЖУРНАЛИСТ", "ЖУРНАЛІСТ")) or term == "ИНТЕРВЬЮ" or term == "ІНТЕРВЮ"): 
            if (OrgItemTypeToken.__m_pressru is None): 
                OrgItemTypeToken.__m_pressru = OrgItemTypeTermin._new1929("ИЗДАНИЕ", MorphLang.RU, OrgProfile.MEDIA, True, 4)
            if (OrgItemTypeToken.__m_pressua is None): 
                OrgItemTypeToken.__m_pressua = OrgItemTypeTermin._new1929("ВИДАННЯ", MorphLang.UA, OrgProfile.MEDIA, True, 4)
            ...
            if (t1.chars.is_latin_letter and not t1.chars.is_all_lower): 
                if (tt.is_value("РЕДАКТОР", None)): 
                    return None
                return OrgItemTypeToken._new1931(t, t, pres.canonic_text.lower(), pres, True)
            if (not say): 
            ...
            if (npt is not None and npt.end_token.next0_ is not None): 
                ...
                if (ok): 
                    if ((root_ == "ИЗДАНИЕ" or root_ == "ИЗДАТЕЛЬСТВО" or root_ == "ЖУРНАЛ") or root_ == "ВИДАННЯ" or root_ == "ВИДАВНИЦТВО"): 
                        res = OrgItemTypeToken._new1933(npt.begin_token, npt.end_token, root_.lower())
                        ...
                        res.root = OrgItemTypeTermin._new1934(root_, True, 4)
                        return res
            rt = t1.kit.process_referent("GEO", t1, None)
            if (rt is not None and rt.morph.class0_.is_adjective): 
                if (rt.end_token.next0_ is not None and rt.end_token.next0_.chars.is_latin_letter): 
                    res = OrgItemTypeToken._new1935(t1, rt.end_token, pres.canonic_text.lower(), pres)
                    res.geo = rt
                    return res
            tt1 = t1
            ...
            if ((((tt1.chars.is_latin_letter and tt1.next0_ is not None and tt1.next0_.is_char('.')) and tt1.next0_.next0_ is not None and tt1.next0_.next0_.chars.is_latin_letter) and (tt1.next0_.next0_.length_char < 4) and tt1.next0_.next0_.length_char > 1) and not tt1.next0_.is_whitespace_after): 
                if (tt1 != t1 and not BracketHelper.can_be_end_of_sequence(tt1.next0_.next0_.next0_, True, t1, False)): 
                    ...
                    res = OrgItemTypeToken._new1935(t1, tt1.next0_.next0_, pres.canonic_text.lower(), pres)
            ...
            if (t.next0_ is not None and t.next0_.chars.is_latin_letter and not t.next0_.chars.is_all_lower): 
                ok = True
            if (ok): 
                res = OrgItemTypeToken._new1933(t, t, t.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False).lower())
                res.profiles.append(OrgProfile.MEDIA)
                res.profiles.append(OrgProfile.PRESS)
                res.root = OrgItemTypeTermin._new1938(t.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), OrgItemTypeTyp.ORG, 3, True)
                res.morph = t.morph
                res.chars = t.chars
            ...
            if (geo_ is not None and geo_.is_state): 
                res = OrgItemTypeToken._new1939(t, t, "министерство", "МИНИСТЕРСТВО ОБОРОНЫ", 4, OrgItemTypeToken.__m_mo)
                res.profiles.append(OrgProfile.STATE)
                res.can_be_organization = True
                return res
        elif ((term == "СУ" and t.chars.is_all_upper and t.previous is not None) and t.previous.is_value("СУДЬЯ", None)): 
            return OrgItemTypeToken._new1940(t, t, "судебный участок", OrgItemTypeToken.__m_sud_uch, True)
            ...
            if (OrgItemNumberToken.try_attach(t.next0_, False, None) is not None): 
                ...
                et = t.next0_
            if (et is not None): 
                return OrgItemTypeToken._new1941(t, et, "исправительная колония", "колония", OrgItemTypeToken.__m_ispr_kolon, True)
        elif (t.is_value("ПАКЕТ", None) and t.next0_ is not None and t.next0_.is_value("АКЦИЯ", "АКЦІЯ")): 
            return OrgItemTypeToken._new1942(t, t.next0_, 4, True, "")
        else: 
            ...
            if (tok is not None and tok.tag is not None): 
                if ((tok.whitespaces_after_count < 2) and BracketHelper.can_be_start_of_sequence(tok.end_token.next0_, True, False)): 
                    return OrgItemTypeToken._new1942(t, tok.end_token, 4, True, "")
        if (res is None and term == "АК" and t.chars.is_all_upper): 
            if (OrgItemTypeToken.try_attach(t.next0_, can_be_first_letter_lower) is not None): 
                return OrgItemTypeToken._new1944(t, t, OrgItemTypeToken.__m_akcion_comp, OrgItemTypeToken.__m_akcion_comp.canonic_text.lower())
        if ((res is None and term == "МО" and t.next0_ is not None) and (t.whitespaces_after_count < 2)): 
            ...
            if (org1 is not None or t.next0_.is_value("МВД", None)): 
                return OrgItemTypeToken._new1944(t, t, OrgItemTypeToken.M_MEJMUN_OTDEL, OrgItemTypeToken.M_MEJMUN_OTDEL.canonic_text.lower())
        if (term == "В"): 
            if ((t.next0_ is not None and t.next0_.is_char_of("\\/") and t.next0_.next0_ is not None) and t.next0_.next0_.is_value("Ч", None)): 
                if (OrgItemNumberToken.try_attach(t.next0_.next0_.next0_, True, None) is not None): 
                    return OrgItemTypeToken._new1944(t, t.next0_.next0_, OrgItemTypeToken.__m_military_unit, OrgItemTypeToken.__m_military_unit.canonic_text.lower())
    ...
    def __try_attach_spec(t : 'Token', can_be_first_letter_lower : bool) -> 'OrgItemTypeToken':
            ...
            if (num is not None and num.end_token.next0_ is not None): 
                ...
                if (oo is not None): 
                    if ("МИГРАЦ" in str(oo).upper()): 
                        return OrgItemTypeToken._new1948(t, t, ("территориальный пункт" if term == "ТП" else "миграционный пункт"), 4, True)
        if (tt.chars.is_all_upper and term == "МГТУ"): 
            if (tt.next0_.is_value("БАНК", None) or (((isinstance(tt.next0_.get_referent(), OrganizationReferent)) and tt.next0_.get_referent().kind == OrganizationKind.BANK)) or ((tt.previous is not None and tt.previous.is_value("ОПЕРУ", None)))): 
                res = OrgItemTypeToken._new1933(tt, tt, "главное территориальное управление")
                res.alt_typ = "ГТУ"
                res.name = "МОСКОВСКОЕ"
    ...
    def __try_attach(t : 'Token', can_be_first_letter_lower : bool, only_keywords : bool=False) -> 'OrgItemTypeToken':
        ...
        if (t.is_value("СБ", None)): 
            if (t.next0_ is not None and (isinstance(t.next0_.get_referent(), GeoReferent))): 
                ...
                if (geo_.is_state): 
                    if (geo_.alpha2 != "RU"): 
                        return OrgItemTypeToken._new1950(t, t, "управление", True, OrgItemTypeToken.__m_sec_serv, OrgItemTypeToken.__m_sec_serv.canonic_text)
                return OrgItemTypeToken._new1950(t, t, "банк", True, OrgItemTypeToken.__m_sber_bank, OrgItemTypeToken.__m_sber_bank.canonic_text)
        ...
        if (npt is None or npt.internal_noun is not None): 
            if (((not t.chars.is_all_lower and t.next0_ is not None and t.next0_.is_hiphen) and not t.is_whitespace_after and not t.next0_.is_whitespace_after) and t.next0_.next0_ is not None and t.next0_.next0_.is_value("БАНК", None)): 
                ...
                res = OrgItemTypeToken._new1952(t, t.next0_.next0_, s, t.next0_.next0_.morph, t.chars, t.next0_.next0_.chars)
        ...
        if (npt.begin_token == npt.end_token): 
            ...
            if (LanguageHelper.ends_with_ex(s, "БАНК", "БАНКА", "БАНОК", None)): 
                if (LanguageHelper.ends_with(s, "БАНКА")): 
                    ...
                    s = (s[0:0+len(s) - 2] + "К")
                res = OrgItemTypeToken._new1952(npt.begin_token, npt.end_token, s, npt.morph, npt.chars, npt.chars)
                res.root = OrgItemTypeToken.__m_bank
                res.typ = "банк"
                return res
            return None
    ...
    def initialize() -> None:
        ...
        i = 0
        while i < len(sovs): 
            t = OrgItemTypeTermin._new1954(sovs[i], MorphLang.RU, OrgProfile.STATE, 4, OrgItemTypeTyp.ORG, True, True)
        ...
        i = 0
        while i < len(sovs): 
            t = OrgItemTypeTermin._new1954(sovs[i], MorphLang.UA, OrgProfile.STATE, 4, OrgItemTypeTyp.ORG, True, True)
            if (sov2[i] is not None): 
                t.add_variant(sov2[i], False)
        ...
        i = 0
        while i < len(sovs): 
            t = OrgItemTypeTermin._new1954(sovs[i], MorphLang.EN, OrgProfile.STATE, 4, OrgItemTypeTyp.ORG, True, True)
            OrgItemTypeToken.__m_global.add(t)
            i += 1
        t = OrgItemTypeTermin._new1957("ГОСУДАРСТВЕННЫЙ КОМИТЕТ", OrgItemTypeTyp.ORG, OrgProfile.STATE, 2)
        t.add_variant("ГОСКОМИТЕТ", False)
        t.add_variant("ГОСКОМ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1958("ДЕРЖАВНИЙ КОМІТЕТ", MorphLang.UA, OrgItemTypeTyp.ORG, OrgProfile.STATE, 2)
        t.add_variant("ДЕРЖКОМІТЕТ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1959("КРАЕВОЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTypeTyp.DEP, OrgProfile.STATE, 3, True)
        t.add_variant("КРАЙКОМСТАТ", False)
        t._profile = OrgProfile.UNIT
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1959("ОБЛАСТНОЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTypeTyp.DEP, OrgProfile.STATE, 3, True)
        t.add_variant("ОБЛКОМСТАТ", False)
        t._profile = OrgProfile.UNIT
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1959("РАЙОННЫЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTypeTyp.DEP, OrgProfile.STATE, 3, True)
        ...
        i = 0
        while i < len(sovs): 
            t = OrgItemTypeTermin._new1962(sovs[i], 2, OrgItemTypeTyp.DEP, OrgProfile.UNIT)
            if (i == 0): 
                t.acronym = "ЦК"
        ...
        for s in ["Standing Committee", "Political Bureau", "Central Committee"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1963(s.upper(), 3, OrgItemTypeTyp.DEP, OrgProfile.UNIT, True))
        sovs = ["ЦЕНТРАЛЬНИЙ КОМІТЕТ", "РАЙОННИЙ КОМІТЕТ", "МІСЬКИЙ КОМІТЕТ", "КРАЙОВИЙ КОМІТЕТ", "ОБЛАСНИЙ КОМІТЕТ"]
        i = 0
        while i < len(sovs): 
            t = OrgItemTypeTermin._new1964(sovs[i], MorphLang.UA, 2, OrgItemTypeTyp.DEP, OrgProfile.UNIT)
            if (i == 0): 
                t.acronym = "ЦК"
                t.can_be_normal_dep = True
            elif (sov2[i] is not None): 
            ...
            OrgItemTypeToken.__m_global.add(t)
            i += 1
        t = OrgItemTypeTermin._new1965("КАЗНАЧЕЙСТВО", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1966("КАЗНАЧЕЙСТВО", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1965("TREASURY", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1965("ПОСОЛЬСТВО", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1965("EMNASSY", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1965("КОНСУЛЬСТВО", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1965("CONSULATE", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1972("ГОСУДАРСТВЕННЫЙ ДЕПАРТАМЕНТ", 5, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ГОСДЕПАРТАМЕНТ", False)
        t.add_variant("ГОСДЕП", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1972("DEPARTMENT OF STATE", 5, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("STATE DEPARTMENT", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1974("ДЕРЖАВНИЙ ДЕПАРТАМЕНТ", MorphLang.UA, 5, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ДЕРЖДЕПАРТАМЕНТ", False)
        t.add_variant("ДЕРЖДЕП", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1975("ДЕПАРТАМЕНТ", 2, OrgItemTypeTyp.ORG))
        t = OrgItemTypeTermin._new1975("DEPARTMENT", 2, OrgItemTypeTyp.ORG)
        t.add_abridge("DEPT.")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1977("АГЕНТСТВО", 1, OrgItemTypeTyp.ORG, True)
        t.add_variant("АГЕНСТВО", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1977("ADGENCY", 1, OrgItemTypeTyp.ORG, True))
        t = OrgItemTypeTermin._new1962("АКАДЕМИЯ", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1980("АКАДЕМІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1962("ACADEMY", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1982("ГЕНЕРАЛЬНЫЙ ШТАБ", 3, OrgItemTypeTyp.DEP, True, True, OrgProfile.ARMY)
        t.add_variant("ГЕНЕРАЛЬНИЙ ШТАБ", False)
        t.add_variant("ГЕНШТАБ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1982("GENERAL STAFF", 3, OrgItemTypeTyp.DEP, True, True, OrgProfile.ARMY)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1984("ФРОНТ", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ВОЕННЫЙ ОКРУГ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1986("ВІЙСЬКОВИЙ ОКРУГ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1984("ГРУППА АРМИЙ", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1988("ГРУПА АРМІЙ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1984("АРМИЯ", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1988("АРМІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1984("ARMY", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ГВАРДИЯ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1986("ГВАРДІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("GUARD", 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY))
        t = OrgItemTypeTermin._new1995("ВОЙСКОВАЯ ЧАСТЬ", 3, "ВЧ", OrgItemTypeTyp.ORG, True, OrgProfile.ARMY)
        OrgItemTypeToken.__m_military_unit = t
        t.add_abridge("В.Ч.")
        t.add_variant("ВОИНСКАЯ ЧАСТЬ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1996("ВІЙСЬКОВА ЧАСТИНА", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
        t.add_abridge("В.Ч.")
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ДИВИЗИЯ", "ДИВИЗИОН", "ПОЛК", "БАТАЛЬОН", "РОТА", "ВЗВОД", "АВИАДИВИЗИЯ", "АВИАПОЛК", "АРТБРИГАДА", "МОТОМЕХБРИГАДА", "ТАНКОВЫЙ КОРПУС", "ГАРНИЗОН", "ДРУЖИНА"]: 
            t = OrgItemTypeTermin._new1997(s, 3, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY)
            if (s == "ГАРНИЗОН"): 
                t.can_be_single_geo = True
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1997("ПОГРАНИЧНЫЙ ОТРЯД", 3, OrgItemTypeTyp.DEP, True, OrgProfile.ARMY)
        t.add_variant("ПОГРАНОТРЯД", False)
        t.add_abridge("ПОГРАН. ОТРЯД")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1997("ПОГРАНИЧНЫЙ ПОЛК", 3, OrgItemTypeTyp.DEP, True, OrgProfile.ARMY)
        ...
        for s in ["ДИВІЗІЯ", "ДИВІЗІОН", "ПОЛК", "БАТАЛЬЙОН", "РОТА", "ВЗВОД", "АВІАДИВІЗІЯ", "АВІАПОЛК", "ПОГРАНПОЛК", "АРТБРИГАДА", "МОТОМЕХБРИГАДА", "ТАНКОВИЙ КОРПУС", "ГАРНІЗОН", "ДРУЖИНА"]: 
            t = OrgItemTypeTermin._new2000(s, 3, MorphLang.UA, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY)
            if (s == "ГАРНІЗОН"): 
                t.can_be_single_geo = True
            OrgItemTypeToken.__m_global.add(t)
        for s in ["КОРПУС", "БРИГАДА"]: 
            t = OrgItemTypeTermin._new1997(s, 1, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["КОРПУС", "БРИГАДА"]: 
            t = OrgItemTypeTermin._new2000(s, 1, MorphLang.UA, OrgItemTypeTyp.ORG, True, OrgProfile.ARMY)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2000("ПРИКОРДОННИЙ ЗАГІН", 3, MorphLang.UA, OrgItemTypeTyp.DEP, True, OrgProfile.ARMY)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1962("ГОСУДАРСТВЕННЫЙ УНИВЕРСИТЕТ", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1980("ДЕРЖАВНИЙ УНІВЕРСИТЕТ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1962("STATE UNIVERSITY", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1962("УНИВЕРСИТЕТ", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1980("УНІВЕРСИТЕТ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2009("UNIVERSITY", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2010("УЧРЕЖДЕНИЕ", 1, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2011("УСТАНОВА", MorphLang.UA, 1, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2010("INSTITUTION", 1, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1975("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ", 3, OrgItemTypeTyp.ORG))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2014("ДЕРЖАВНА УСТАНОВА", MorphLang.UA, 3, OrgItemTypeTyp.ORG))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1965("STATE INSTITUTION", 3, OrgItemTypeTyp.ORG, True))
        t = OrgItemTypeTermin._new1962("ИНСТИТУТ", 2, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1980("ІНСТИТУТ", MorphLang.UA, 2, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1962("INSTITUTE", 2, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION)
        t.profiles.append(OrgProfile.SCIENCE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2019("ОТДЕЛ СУДЕБНЫХ ПРИСТАВОВ", OrgItemTypeTyp.PREFIX, "ОСП", OrgProfile.UNIT, True, True)
        t.profiles.append(OrgProfile.JUSTICE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2019("МЕЖРАЙОННЫЙ ОТДЕЛ СУДЕБНЫХ ПРИСТАВОВ", OrgItemTypeTyp.PREFIX, "МОСП", OrgProfile.UNIT, True, True)
        t.add_variant("МЕЖРАЙОННЫЙ ОСП", False)
        t.profiles.append(OrgProfile.JUSTICE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2019("ОТДЕЛ ВНЕВЕДОМСТВЕННОЙ ОХРАНЫ", OrgItemTypeTyp.PREFIX, "ОВО", OrgProfile.UNIT, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2019("ОТДЕЛ ПО ВОПРОСАМ МИГРАЦИИ", OrgItemTypeTyp.PREFIX, "ОВМ", OrgProfile.UNIT, True, True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2023("ЛИЦЕЙ", 2, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2024("ЛІЦЕЙ", MorphLang.UA, 2, OrgProfile.EDUCATION, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2023("ИНТЕРНАТ", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2024("ІНТЕРНАТ", MorphLang.UA, 3, OrgProfile.EDUCATION, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("HIGH SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("SECONDARY SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("MIDDLE SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("PUBLIC SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("JUNIOR SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2027("GRAMMAR SCHOOL", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True))
        t = OrgItemTypeTermin._new2033("СРЕДНЯЯ ШКОЛА", 3, "СШ", OrgItemTypeTyp.ORG, OrgProfile.EDUCATION, True, True)
        ...
        t.add_abridge("ООШ")
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2034("БИЗНЕС ШКОЛА", 3, OrgItemTypeTyp.ORG, True, True, True, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2034("БІЗНЕС ШКОЛА", 3, OrgItemTypeTyp.ORG, True, True, True, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2024("СЕРЕДНЯ ШКОЛА", MorphLang.UA, 3, OrgProfile.EDUCATION, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1962("ВЫСШАЯ ШКОЛА", 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1980("ВИЩА ШКОЛА", MorphLang.UA, 3, OrgItemTypeTyp.ORG, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("НАЧАЛЬНАЯ ШКОЛА", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ПОЧАТКОВА ШКОЛА", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("СЕМИНАРИЯ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("СЕМІНАРІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ГИМНАЗИЯ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ГІМНАЗІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        t = OrgItemTypeTermin._new1995("СПЕЦИАЛИЗИРОВАННАЯ ДЕТСКО ЮНОШЕСКАЯ СПОРТИВНАЯ ШКОЛА ОЛИМПИЙСКОГО РЕЗЕРВА", 3, "СДЮСШОР", OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1995("ДЕТСКО ЮНОШЕСКАЯ СПОРТИВНАЯ ШКОЛА ОЛИМПИЙСКОГО РЕЗЕРВА", 3, "ДЮСШОР", OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1995("ДЕТСКО ЮНОШЕСКАЯ СПОРТИВНАЯ ШКОЛА", 3, "ДЮСШ", OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1997("ДЕТСКИЙ САД", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        t.add_variant("ДЕТСАД", False)
        t.add_abridge("Д.С.")
        t.add_abridge("Д/С")
        t.add_variant("ЯСЛИ САД", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2040("ДИТЯЧИЙ САДОК", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        t.add_variant("ДИТСАДОК", False)
        t.add_abridge("Д.С.")
        t.add_abridge("Д/З")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1997("ДЕТСКИЙ ДОМ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        t.add_variant("ДЕТДОМ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2040("ДИТЯЧИЙ БУДИНОК", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION)
        t.add_variant("ДИТБУДИНОК", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2052("ДОМ ДЕТСКОГО ТВОРЧЕСТВА", 3, "ДДТ", OrgItemTypeTyp.ORG, True, True, OrgProfile.EDUCATION)
        ...
        t.add_variant("ДВОРЕЦ ДЕТСКОГО (ЮНОШЕСКОГО) ТВОРЧЕСТВА", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ШКОЛА", 1, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2054("SCHOOL", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("УЧИЛИЩЕ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("КОЛЛЕДЖ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("КОЛЛЕГИУМ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ТЕХНИКУМ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2054("COLLEGE", 3, OrgItemTypeTyp.ORG, True, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2060("ЦЕНТР", OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1962("НАУЧНЫЙ ЦЕНТР", 3, OrgItemTypeTyp.ORG, OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1980("НАУКОВИЙ ЦЕНТР", MorphLang.UA, 3, OrgItemTypeTyp.ORG, OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2063("УЧЕБНО ВОСПИТАТЕЛЬНЫЙ КОМПЛЕКС", 3, OrgItemTypeTyp.ORG, "УВК", True, OrgProfile.EDUCATION, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2064("НАВЧАЛЬНО ВИХОВНИЙ КОМПЛЕКС", MorphLang.UA, 3, OrgItemTypeTyp.ORG, "УВК", True, OrgProfile.EDUCATION, True))
        t = OrgItemTypeTermin._new2065("ПРОФЕССИОНАЛЬНО ТЕХНИЧЕСКОЕ УЧИЛИЩЕ", 2, OrgItemTypeTyp.ORG, "ПТУ", True, OrgProfile.EDUCATION)
        t.add_variant("ПРОФТЕХУЧИЛИЩЕ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2065("ГОСУДАРСТВЕННОЕ ПРОФЕССИОНАЛЬНО ТЕХНИЧЕСКОЕ УЧИЛИЩЕ", 2, OrgItemTypeTyp.ORG, "ГПТУ", True, OrgProfile.EDUCATION)
        t.add_variant("ГОСПРОФТЕХУЧИЛИЩЕ", False)
        t.add_variant("ГОСУДАРСТВЕННОЕ ПРОФТЕХУЧИЛИЩЕ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2065("СРЕДНЕЕ ПРОФЕССИОНАЛЬНО ТЕХНИЧЕСКОЕ УЧИЛИЩЕ", 2, OrgItemTypeTyp.ORG, "СПТУ", True, OrgProfile.EDUCATION)
        t.add_variant("СРЕДНЕЕ ПРОФТЕХУЧИЛИЩЕ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2065("ПРОФЕССИОНАЛЬНО ТЕХНИЧЕСКАЯ ШКОЛА", 2, OrgItemTypeTyp.ORG, "ПТШ", True, OrgProfile.EDUCATION)
        t.add_variant("ПРОФТЕХШКОЛА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2065("ПРОФЕСІЙНО ТЕХНІЧНЕ УЧИЛИЩЕ", 2, OrgItemTypeTyp.ORG, "ПТУ", True, OrgProfile.EDUCATION)
        t.add_variant("ПРОФТЕХУЧИЛИЩЕ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2065("ПРОФЕСІЙНО ТЕХНІЧНА ШКОЛА", 2, OrgItemTypeTyp.ORG, "ПТШ", True, OrgProfile.EDUCATION)
        t.add_variant("ПРОФТЕХШКОЛА", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("БОЛЬНИЦА", 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ЛІКАРНЯ", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("МОРГ", 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("МОРГ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ХОСПИС", 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ХОСПІС", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        t = OrgItemTypeTermin._new1997("ГОРОДСКАЯ БОЛЬНИЦА", 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        t.add_abridge("ГОР.БОЛЬНИЦА")
        t.add_variant("ГОРБОЛЬНИЦА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2040("МІСЬКА ЛІКАРНЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2079("ГОРОДСКАЯ КЛИНИЧЕСКАЯ БОЛЬНИЦА", 3, OrgItemTypeTyp.ORG, True, "ГКБ", OrgProfile.MEDICINE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2080("МІСЬКА КЛІНІЧНА ЛІКАРНЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, "МКЛ", OrgProfile.MEDICINE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("КЛАДБИЩЕ", 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1996("КЛАДОВИЩЕ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ПОЛИКЛИНИКА", 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ПОЛІКЛІНІКА", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("ГОСПИТАЛЬ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("ГОСПІТАЛЬ", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1997("КЛИНИКА", 1, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2040("КЛІНІКА", MorphLang.UA, 1, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE))
        t = OrgItemTypeTermin._new1997("МЕДИКО САНИТАРНАЯ ЧАСТЬ", 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        t.add_variant("МЕДСАНЧАСТЬ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2040("МЕДИКО САНІТАРНА ЧАСТИНА", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        t.add_variant("МЕДСАНЧАСТИНА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2091("МЕДИЦИНСКИЙ ЦЕНТР", 2, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.MEDICINE)
        t.add_variant("МЕДЦЕНТР", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2092("МЕДИЧНИЙ ЦЕНТР", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.MEDICINE)
        t.add_variant("МЕДЦЕНТР", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1997("РОДИЛЬНЫЙ ДОМ", 1, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        t.add_variant("РОДДОМ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2040("ПОЛОГОВИЙ БУДИНОК", MorphLang.UA, 1, OrgItemTypeTyp.ORG, True, OrgProfile.MEDICINE)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2095("АЭРОПОРТ", 3, OrgItemTypeTyp.ORG, True, True, True, True, OrgProfile.TRANSPORT)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2096("АЕРОПОРТ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2095("ТОРГОВЫЙ ПОРТ", 3, OrgItemTypeTyp.ORG, True, True, True, True, OrgProfile.TRANSPORT)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2095("МОРСКОЙ ТОРГОВЫЙ ПОРТ", 3, OrgItemTypeTyp.ORG, True, True, True, True, OrgProfile.TRANSPORT)
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ТЕАТР", "ТЕАТР-СТУДИЯ", "КИНОТЕАТР", "МУЗЕЙ", "ГАЛЕРЕЯ", "КОНЦЕРТНЫЙ ЗАЛ", "ФИЛАРМОНИЯ", "КОНСЕРВАТОРИЯ", "ДОМ КУЛЬТУРЫ", "ДВОРЕЦ КУЛЬТУРЫ", "ДВОРЕЦ ПИОНЕРОВ", "ДВОРЕЦ СПОРТА", "ДВОРЕЦ ТВОРЧЕСТВА", "ДОМ ПИОНЕРОВ", "ДОМ СПОРТА", "ДОМ ТВОРЧЕСТВА"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1977(s, 3, OrgItemTypeTyp.ORG, True))
        for s in ["ТЕАТР", "ТЕАТР-СТУДІЯ", "КІНОТЕАТР", "МУЗЕЙ", "ГАЛЕРЕЯ", "КОНЦЕРТНИЙ ЗАЛ", "ФІЛАРМОНІЯ", "КОНСЕРВАТОРІЯ", "БУДИНОК КУЛЬТУРИ", "ПАЛАЦ КУЛЬТУРИ", "ПАЛАЦ ПІОНЕРІВ", "ПАЛАЦ СПОРТУ", "ПАЛАЦ ТВОРЧОСТІ", "БУДИНОК ПІОНЕРІВ", "БУДИНОК СПОРТУ", "БУДИНОК ТВОРЧОСТІ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2100(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2101("БИБЛИОТЕКА", 3, OrgItemTypeTyp.ORG, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2102("БІБЛІОТЕКА", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True))
        for s in ["ЦЕРКОВЬ", "ХРАМ", "СОБОР", "МЕЧЕТЬ", "СИНАГОГА", "МОНАСТЫРЬ", "ЛАВРА", "ПАТРИАРХАТ", "МЕДРЕСЕ", "СЕКТА", "РЕЛИГИОЗНАЯ ГРУППА", "РЕЛИГИОЗНОЕ ОБЪЕДИНЕНИЕ", "РЕЛИГИОЗНАЯ ОРГАНИЗАЦИЯ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2103(s, 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.RELIGION))
        for s in ["ЦЕРКВА", "ХРАМ", "СОБОР", "МЕЧЕТЬ", "СИНАГОГА", "МОНАСТИР", "ЛАВРА", "ПАТРІАРХАТ", "МЕДРЕСЕ", "СЕКТА", "РЕЛІГІЙНА ГРУПА", "РЕЛІГІЙНЕ ОБЄДНАННЯ", " РЕЛІГІЙНА ОРГАНІЗАЦІЯ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2104(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.RELIGION))
        for s in ["ФЕДЕРАЛЬНАЯ СЛУЖБА", "ГОСУДАРСТВЕННАЯ СЛУЖБА", "ФЕДЕРАЛЬНОЕ УПРАВЛЕНИЕ", "ГОСУДАРСТВЕННЫЙ КОМИТЕТ", "ГОСУДАРСТВЕННАЯ ИНСПЕКЦИЯ"]: 
            t = OrgItemTypeTermin._new2105(s, 3, OrgItemTypeTyp.ORG, True)
            OrgItemTypeToken.__m_global.add(t)
            t = OrgItemTypeTermin._new2106(s, 3, OrgItemTypeTyp.ORG, s)
            t.terms.insert(1, Termin.Term._new2107(None, True))
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ФЕДЕРАЛЬНА СЛУЖБА", "ДЕРЖАВНА СЛУЖБА", "ФЕДЕРАЛЬНЕ УПРАВЛІННЯ", "ДЕРЖАВНИЙ КОМІТЕТ УКРАЇНИ", "ДЕРЖАВНА ІНСПЕКЦІЯ"]: 
            t = OrgItemTypeTermin._new2108(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
            OrgItemTypeToken.__m_global.add(t)
            t = OrgItemTypeTermin._new2109(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, s)
            t.terms.insert(1, Termin.Term._new2107(None, True))
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("СЛЕДСТВЕННЫЙ ИЗОЛЯТОР", 5, OrgItemTypeTyp.ORG, True)
        t.add_variant("СИЗО", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new1996("СЛІДЧИЙ ІЗОЛЯТОР", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
        t.add_variant("СІЗО", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2081("КОЛОНИЯ-ПОСЕЛЕНИЕ", 3, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1996("КОЛОНІЯ-ПОСЕЛЕННЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2115("ТЮРЬМА", 3, OrgItemTypeTyp.ORG, True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2116("ВЯЗНИЦЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2081("КОЛОНИЯ", 2, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1996("КОЛОНІЯ", MorphLang.UA, 2, OrgItemTypeTyp.ORG, True))
        OrgItemTypeToken.__m_ispr_kolon = OrgItemTypeTermin._new2119("ИСПРАВИТЕЛЬНАЯ КОЛОНИЯ", 3, OrgItemTypeTyp.ORG, "ИК", True)
        OrgItemTypeToken.__m_global.add(OrgItemTypeToken.__m_ispr_kolon)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1996("ВИПРАВНА КОЛОНІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True))
        for s in ["ПОЛИЦИЯ", "МИЛИЦИЯ"]: 
            t = OrgItemTypeTermin._new2121(s, OrgItemTypeTyp.ORG, 3, True, False)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ПОЛІЦІЯ", "МІЛІЦІЯ"]: 
            t = OrgItemTypeTermin._new2122(s, MorphLang.UA, OrgItemTypeTyp.ORG, 3, True, False)
            OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2123("ПАЕВЫЙ ИНВЕСТИЦИОННЫЙ ФОНД", 2, OrgItemTypeTyp.ORG, "ПИФ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2124("РОССИЙСКОЕ ИНФОРМАЦИОННОЕ АГЕНТСТВО", 3, OrgItemTypeTyp.ORG, "РИА", OrgProfile.MEDIA))
        t = OrgItemTypeTermin._new2124("ИНФОРМАЦИОННОЕ АГЕНТСТВО", 3, OrgItemTypeTyp.ORG, "ИА", OrgProfile.MEDIA)
        t.add_variant("ИНФОРМАГЕНТСТВО", False)
        t.add_variant("ИНФОРМАГЕНСТВО", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2126("ОТДЕЛ", 1, OrgItemTypeTyp.DEP, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2127("ВІДДІЛ", MorphLang.UA, 1, OrgItemTypeTyp.DEP, True, True))
        t = OrgItemTypeTermin._new2128("РАЙОННЫЙ ОТДЕЛ", 2, "РО", OrgItemTypeTyp.DEP, True)
        t.add_variant("РАЙОТДЕЛ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2129("РАЙОННИЙ ВІДДІЛ", MorphLang.UA, 2, "РВ", OrgItemTypeTyp.DEP, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("ЦЕХ", 3, OrgItemTypeTyp.DEP, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("ФАКУЛЬТЕТ", 3, OrgItemTypeTyp.DEP, True)
        t.add_abridge("ФАК.")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("КАФЕДРА", 3, OrgItemTypeTyp.DEP, True)
        t.add_abridge("КАФ.")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("ЛАБОРАТОРИЯ", 1, OrgItemTypeTyp.DEP, True)
        t.add_abridge("ЛАБ.")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2134("ЛАБОРАТОРІЯ", MorphLang.UA, 1, OrgItemTypeTyp.DEP, True)
        t.add_abridge("ЛАБ.")
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ПАТРИАРХИЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ПАТРІАРХІЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ЕПАРХИЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("ЄПАРХІЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("МИТРОПОЛИЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new1985("МИТРОПОЛІЯ", 3, OrgItemTypeTyp.DEP, True, OrgProfile.RELIGION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2141("ПРЕДСТАВИТЕЛЬСТВО", OrgItemTypeTyp.DEPADD))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2142("ПРЕДСТАВНИЦТВО", MorphLang.UA, OrgItemTypeTyp.DEPADD))
        t = OrgItemTypeTermin._new2060("ОТДЕЛЕНИЕ", OrgItemTypeTyp.DEPADD, True)
        t.add_abridge("ОТД.")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2144("ВІДДІЛЕННЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2060("ИНСПЕКЦИЯ", OrgItemTypeTyp.DEPADD, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2144("ІНСПЕКЦІЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2141("ФИЛИАЛ", OrgItemTypeTyp.DEPADD))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2142("ФІЛІЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD))
        t = OrgItemTypeTermin._new2149("ОФИС", OrgItemTypeTyp.DEPADD, True, True)
        t.add_variant("ОПЕРАЦИОННЫЙ ОФИС", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2150("ОФІС", MorphLang.UA, OrgItemTypeTyp.DEPADD, True, True)
        t.add_variant("ОПЕРАЦІЙНИЙ ОФІС", False)
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ОТДЕЛ ПОЛИЦИИ", "ОТДЕЛ МИЛИЦИИ", "ОТДЕЛЕНИЕ ПОЛИЦИИ", "ОТДЕЛЕНИЕ МИЛИЦИИ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2151(s, OrgItemTypeTyp.DEP, 1.5, True, True))
            if (s.startswith("ОТДЕЛ ")): 
                t = OrgItemTypeTermin._new2151("ГОРОДСКОЙ " + s, OrgItemTypeTyp.DEP, 3, True, True)
                t.add_variant("ГОР" + s, False)
                OrgItemTypeToken.__m_global.add(t)
                t = OrgItemTypeTermin._new2153("РАЙОННЫЙ " + s, "РО", OrgItemTypeTyp.DEP, 3, True, True)
                OrgItemTypeToken.__m_global.add(t)
        for s in ["ВІДДІЛ ПОЛІЦІЇ", "ВІДДІЛ МІЛІЦІЇ", "ВІДДІЛЕННЯ ПОЛІЦІЇ", "ВІДДІЛЕННЯ МІЛІЦІЇ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2154(s, MorphLang.UA, OrgItemTypeTyp.DEP, 1.5, True, True))
        t = OrgItemTypeTermin._new2151("МЕЖМУНИЦИПАЛЬНЫЙ ОТДЕЛ", OrgItemTypeTyp.DEP, 1.5, True, True)
        OrgItemTypeToken.M_MEJMUN_OTDEL = t
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ГЛАВНОЕ УПРАВЛЕНИЕ", "ГУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ЛИНЕЙНОЕ УПРАВЛЕНИЕ", "ЛУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("МЕЖМУНИЦИПАЛЬНОЕ УПРАВЛЕНИЕ", "МУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2159("ГОЛОВНЕ УПРАВЛІННЯ", MorphLang.UA, "ГУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ГЛАВНОЕ ТЕРРИТОРИАЛЬНОЕ УПРАВЛЕНИЕ", "ГТУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2159("ГОЛОВНЕ ТЕРИТОРІАЛЬНЕ УПРАВЛІННЯ", MorphLang.UA, "ГТУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2162("СЛЕДСТВЕННОЕ УПРАВЛЕНИЕ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2163("СЛІДЧЕ УПРАВЛІННЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ГЛАВНОЕ СЛЕДСТВЕННОЕ УПРАВЛЕНИЕ", "ГСУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2159("ГОЛОВНЕ СЛІДЧЕ УПРАВЛІННЯ", MorphLang.UA, "ГСУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ОПЕРАЦИОННОЕ УПРАВЛЕНИЕ", "ОПЕРУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2159("ОПЕРАЦІЙНЕ УПРАВЛІННЯ", MorphLang.UA, "ОПЕРУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2162("ТЕРРИТОРИАЛЬНОЕ УПРАВЛЕНИЕ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2163("ТЕРИТОРІАЛЬНЕ УПРАВЛІННЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("РЕГИОНАЛЬНОЕ УПРАВЛЕНИЕ", "РУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2159("РЕГІОНАЛЬНЕ УПРАВЛІННЯ", MorphLang.UA, "РУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2060("УПРАВЛЕНИЕ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2144("УПРАВЛІННЯ", MorphLang.UA, OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2156("ПОГРАНИЧНОЕ УПРАВЛЕНИЕ", "ПУ", OrgItemTypeTyp.DEPADD, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2175("ДЕЖУРНАЯ ЧАСТЬ", "ДЧ", OrgItemTypeTyp.DEPADD, True, OrgProfile.UNIT)
        t.add_abridge("Д/Ч")
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ПРЕСС-СЛУЖБА", "ПРЕСС-ЦЕНТР", "КОЛЛ-ЦЕНТР", "БУХГАЛТЕРИЯ", "МАГИСТРАТУРА", "АСПИРАНТУРА", "ДОКТОРАНТУРА", "ОРДИНАТУРА", "СОВЕТ ДИРЕКТОРОВ", "УЧЕНЫЙ СОВЕТ", "КОЛЛЕГИЯ", "НАБЛЮДАТЕЛЬНЫЙ СОВЕТ", "ОБЩЕСТВЕННЫЙ СОВЕТ", "ДИРЕКЦИЯ", "ЖЮРИ", "ПРЕЗИДИУМ", "СЕКРЕТАРИАТ", "СИНОД", "ПЛЕНУМ", "АППАРАТ", "PRESS CENTER", "CLIENT CENTER", "CALL CENTER", "ACCOUNTING", "MASTER DEGREE", "POSTGRADUATE", "DOCTORATE", "RESIDENCY", "BOARD OF DIRECTORS", "DIRECTOR BOARD", "ACADEMIC COUNCIL", "PLENARY", "SUPERVISORY BOARD", "PUBLIC COUNCIL", "LEADERSHIP", "JURY", "BUREAU", "SECRETARIAT"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2176(s, OrgItemTypeTyp.DEPADD, True, OrgProfile.UNIT))
        for s in ["ПРЕС-СЛУЖБА", "ПРЕС-ЦЕНТР", "БУХГАЛТЕРІЯ", "МАГІСТРАТУРА", "АСПІРАНТУРА", "ДОКТОРАНТУРА", "ОРДИНАТУРА", "РАДА ДИРЕКТОРІВ", "ВЧЕНА РАДА", "КОЛЕГІЯ", "ПЛЕНУМ", "НАГЛЯДОВА РАДА", "ГРОМАДСЬКА РАДА", "ДИРЕКЦІЯ", "ЖУРІ", "ПРЕЗИДІЯ", "СЕКРЕТАРІАТ", "АПАРАТ"]: 
            OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2177(s, MorphLang.UA, OrgItemTypeTyp.DEPADD, True, OrgProfile.UNIT))
        t = OrgItemTypeTermin._new2176("ОТДЕЛ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ", OrgItemTypeTyp.DEPADD, True, OrgProfile.UNIT)
        t.add_variant("ОТДЕЛ ИБ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2176("ОТДЕЛ ИНФОРМАЦИОННЫХ ТЕХНОЛОГИЙ", OrgItemTypeTyp.DEPADD, True, OrgProfile.UNIT)
        t.add_variant("ОТДЕЛ ИТ", False)
        t.add_variant("ОТДЕЛ IT", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2060("СЕКТОР", OrgItemTypeTyp.DEP, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2181("КУРС", OrgItemTypeTyp.DEP, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2182("ГРУППА", OrgItemTypeTyp.DEP, True, True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2183("ГРУПА", MorphLang.UA, OrgItemTypeTyp.DEP, True, True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2176("ДНЕВНОЕ ОТДЕЛЕНИЕ", OrgItemTypeTyp.DEP, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2177("ДЕННЕ ВІДДІЛЕННЯ", MorphLang.UA, OrgItemTypeTyp.DEP, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2176("ВЕЧЕРНЕЕ ОТДЕЛЕНИЕ", OrgItemTypeTyp.DEP, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2177("ВЕЧІРНЄ ВІДДІЛЕННЯ", MorphLang.UA, OrgItemTypeTyp.DEP, True, OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2162("ДЕЖУРНАЯ ЧАСТЬ", OrgItemTypeTyp.DEP, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2163("ЧЕРГОВА ЧАСТИНА", MorphLang.UA, OrgItemTypeTyp.DEP, True))
        t = OrgItemTypeTermin._new2190("ПАСПОРТНЫЙ СТОЛ", OrgItemTypeTyp.DEP, True)
        t.add_abridge("П/С")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2191("ПАСПОРТНИЙ СТІЛ", MorphLang.UA, OrgItemTypeTyp.DEP, True)
        t.add_abridge("П/С")
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2192("ВЫСШЕЕ УЧЕБНОЕ ЗАВЕДЕНИЕ", OrgItemTypeTyp.PREFIX, OrgProfile.EDUCATION, "ВУЗ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2193("ВИЩИЙ НАВЧАЛЬНИЙ ЗАКЛАД", MorphLang.UA, OrgItemTypeTyp.PREFIX, OrgProfile.EDUCATION, "ВНЗ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2192("ВЫСШЕЕ ПРОФЕССИОНАЛЬНОЕ УЧИЛИЩЕ", OrgItemTypeTyp.PREFIX, OrgProfile.EDUCATION, "ВПУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2193("ВИЩЕ ПРОФЕСІЙНЕ УЧИЛИЩЕ", MorphLang.UA, OrgItemTypeTyp.PREFIX, OrgProfile.EDUCATION, "ВПУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2192("НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTypeTyp.PREFIX, OrgProfile.SCIENCE, "НИИ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2193("НАУКОВО ДОСЛІДНИЙ ІНСТИТУТ", MorphLang.UA, OrgItemTypeTyp.PREFIX, OrgProfile.SCIENCE, "НДІ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2192("НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ И ПРОЕКТНЫЙ ИНСТИТУТ", OrgItemTypeTyp.PREFIX, OrgProfile.SCIENCE, "НИПИ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, "НИЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННЫЙ НАУЧНЫЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, "ГНЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАЦИОНАЛЬНЫЙ ИССЛЕДОВАТЕЛЬСКИЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, "НИЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ДОСЛІДНИЙ ЦЕНТР", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НДЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ЦЕНТРАЛЬНЫЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTypeTyp.PREFIX, "ЦНИИ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ВСЕРОССИЙСКИЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTypeTyp.PREFIX, "ВНИИ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("РОССИЙСКИЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTypeTyp.PREFIX, "РНИИ", OrgProfile.SCIENCE))
        t = OrgItemTypeTermin._new2206("ИННОВАЦИОННЫЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, OrgProfile.SCIENCE)
        t.add_variant("ИННОЦЕНТР", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ТЕХНИЧЕСКИЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, "НТЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ТЕХНІЧНИЙ ЦЕНТР", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НТЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ТЕХНИЧЕСКАЯ ФИРМА", OrgItemTypeTyp.PREFIX, "НТФ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ВИРОБНИЧА ФІРМА", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НВФ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ПРОИЗВОДСТВЕННОЕ ОБЪЕДИНЕНИЕ", OrgItemTypeTyp.PREFIX, "НПО", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ВИРОБНИЧЕ ОБЄДНАННЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НВО", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2206("НАУЧНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО-ВИРОБНИЧИЙ КООПЕРАТИВ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НВК", OrgProfile.SCIENCE))
        t = OrgItemTypeTermin._new2199("НАУЧНО ПРОИЗВОДСТВЕННАЯ КОРПОРАЦИЯ", OrgItemTypeTyp.PREFIX, "НПК", OrgProfile.SCIENCE)
        t.add_variant("НАУЧНО ПРОИЗВОДСТВЕННАЯ КОМПАНИЯ", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ТЕХНИЧЕСКИЙ КОМПЛЕКС", OrgItemTypeTyp.PREFIX, "НТК", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МЕЖОТРАСЛЕВОЙ НАУЧНО ТЕХНИЧЕСКИЙ КОМПЛЕКС", OrgItemTypeTyp.PREFIX, "МНТК", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "НПП", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ВИРОБНИЧЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НВП", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ПРОИЗВОДСТВЕННЫЙ ЦЕНТР", OrgItemTypeTyp.PREFIX, "НПЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2202("НАУКОВО ВИРОБНИЧЕ ЦЕНТР", MorphLang.UA, OrgItemTypeTyp.PREFIX, "НВЦ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НАУЧНО ПРОИЗВОДСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "НПУП", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ИНДИВИДУАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ИП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ПРИВАТНЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ПП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ПРОИЗВОДСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧПУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ИНДИВИДУАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧИП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ОХРАННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧОП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНАЯ ОХРАННАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, "ЧОО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ТРАНСПОРТНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧТУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ЧАСТНОЕ ТРАНСПОРТНО ЭКСПЛУАТАЦИОННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ЧТЭУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("НАУЧНО ПРОИЗВОДСТВЕННОЕ КОРПОРАЦИЯ", OrgItemTypeTyp.PREFIX, "НПК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ФГУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ГОСУДАРСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ГУП"))
        t = OrgItemTypeTermin._new2223("ГОСУДАРСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ГП")
        t.add_variant("ГОСПРЕДПРИЯТИЕ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2225("ДЕРЖАВНЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ДП")
        t.add_variant("ДЕРЖПІДПРИЄМСТВО", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ НАУЧНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГНУ", OrgProfile.SCIENCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГКУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ КАЗЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГКОУ"))
        t = OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГБУ")
        t.add_variant("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ НАУКИ", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ВОЕННО ПРОМЫШЛЕННАЯ КОРПОРАЦИЯ", OrgItemTypeTyp.PREFIX, "ВПК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ЧАСТНАЯ ВОЕННАЯ КОМПАНИЯ", OrgItemTypeTyp.PREFIX, "ЧВК", OrgProfile.ARMY))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФБУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "ФУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФКУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ НЕКОММЕРЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МНУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МБУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МАУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МКУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "МУП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ УНИТАРНОЕ ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "МУПП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "МКП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("МУНИЦИПАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, "МП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("НЕБАНКОВСКАЯ КРЕДИТНАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, "НКО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("РАСЧЕТНАЯ НЕБАНКОВСКАЯ КРЕДИТНАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, "РНКО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГБУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГКУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГАУ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2141("МАЛОЕ ИННОВАЦИОННОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("НЕГОСУДАРСТВЕННЫЙ ПЕНСИОННЫЙ ФОНД", OrgItemTypeTyp.PREFIX, "НПФ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2141("ЧАСТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ДЕРЖАВНА АКЦІОНЕРНА КОМПАНІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ДАК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ДЕРЖАВНА КОМПАНІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ДК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("КОЛЕКТИВНЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "КП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("КОЛЕКТИВНЕ МАЛЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "КМП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ВИРОБНИЧА ФІРМА", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ВФ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ВИРОБНИЧЕ ОБЄДНАННЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ВО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ВИРОБНИЧЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ВП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ВИРОБНИЧИЙ КООПЕРАТИВ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ВК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("СТРАХОВА КОМПАНІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "СК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2225("ТВОРЧЕ ОБЄДНАННЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ТО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ФГУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ФКУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГАУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ОБЛАСТНОЕ ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ОГАУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ФГБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ФБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ОБЛАСТНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ОГБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГОБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГКУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "ГОКУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "МУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НЕГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "НУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "МБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "МКУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "МОБУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "МАУЗ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2206("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ФГУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ФКУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ГАУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ГБУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ГОБУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ГКУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ГОКУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "МУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НЕГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "НУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "МБУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "МКУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "МОБУК", OrgProfile.CULTURE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "МАУК", OrgProfile.CULTURE))
        t = OrgItemTypeTermin._new2223("ЧАСТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTypeTyp.PREFIX, "ЧУК")
        t.add_variant("ЧАСТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ ЛФП", False)
        t.add_variant("ЧУК ЛФП", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "ГБУО", OrgProfile.EDUCATION))
        t = OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГБПОУ", OrgProfile.EDUCATION)
        t.add_variant("ГБ ПОУ", True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБЩЕОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГБОУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ДОПОЛНИТЕЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "ГБУДО", OrgProfile.EDUCATION))
        t = OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГАОУ", OrgProfile.EDUCATION)
        ...
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ЧАСТНОЕ УЧРЕЖДЕНИЕ ДОПОЛНИТЕЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "ЧУДО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ЧАСТНОЕ УЧРЕЖДЕНИЕ ДОПОЛНИТЕЛЬНОГО ПРОФЕССИОНАЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "ЧУДПО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МОУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МКОУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ ОБЩЕОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МАОУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("АВТОНОМНАЯ НЕКОММЕРЧЕСКАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, "АНО", OrgProfile.EDUCATION))
        t = OrgItemTypeTermin._new2199("АВТОНОМНАЯ НЕКОММЕРЧЕСКАЯ ОРГАНИЗАЦИЯ ДОПОЛНИТЕЛЬНОГО ПРОФЕССИОНАЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "АНОДПО", OrgProfile.EDUCATION)
        t.add_variant("АНО ДПО", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("НЕГОСУДАРСТВЕННОЕ ОБРАЗОВАТЕЛЬНОЕ ЧАСТНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "НОЧУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("МУНИЦИПАЛЬНОЕ ЛЕЧЕБНО ПРОФИЛАКТИЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "МЛПУ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ ЛЕЧЕБНО ПРОФИЛАКТИЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФКЛПУ", OrgProfile.MEDICINE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГОУ", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ГБОУ", OrgProfile.EDUCATION))
        t = OrgItemTypeTermin._new2199("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTypeTyp.PREFIX, "ФГБОУ", OrgProfile.EDUCATION)
        ...
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ВЫСШЕЕ ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАНИЕ", OrgItemTypeTyp.PREFIX, "ВПО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ДОПОЛНИТЕЛЬНОЕ ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАНИЕ", OrgItemTypeTyp.PREFIX, "ДПО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ОРГАНИЗАЦИЯ ДОПОЛНИТЕЛЬНОГО ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАНИЕ", OrgItemTypeTyp.PREFIX, "ОДПО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2199("ЦЕНТР ПРОФЕССИОНАЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTypeTyp.PREFIX, "ЦПО", OrgProfile.EDUCATION))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2330("ДЕПАРТАМЕНТ ЕДИНОГО ЗАКАЗЧИКА", OrgItemTypeTyp.PREFIX, "ДЕЗ", True, True))
        t = OrgItemTypeTermin._new2331("СОЮЗ АРБИТРАЖНЫХ УПРАВЛЯЮЩИХ", OrgItemTypeTyp.PREFIX, "САУ", True)
        t.add_variant("САМОРЕГУЛИРУЕМАЯ ОРГАНИЗАЦИЯ АРБИТРАЖНЫХ УПРАВЛЯЮЩИХ", False)
        t.add_variant("СОАУ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2331("ОПЫТНО ПРОИЗВОДСТВЕННОЕ ХОЗЯЙСТВО", OrgItemTypeTyp.PREFIX, "ОПХ", True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2331("ОРГАНИЗАЦИЯ НАУЧНОГО ОБСЛУЖИВАНИЯ", OrgItemTypeTyp.PREFIX, "ОНО", True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "АО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АТ"))
        OrgItemTypeToken.__m_sovm_pred = OrgItemTypeTermin._new2334("СОВМЕСТНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, True, "СП")
        OrgItemTypeToken.__m_global.add(OrgItemTypeToken.__m_sovm_pred)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("СПІЛЬНЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "СП"))
        OrgItemTypeToken.__m_akcion_comp = OrgItemTypeTermin._new2338("АКЦИОНЕРНАЯ КОМПАНИЯ", OrgItemTypeTyp.PREFIX, True)
        OrgItemTypeToken.__m_global.add(OrgItemTypeToken.__m_akcion_comp)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2331("УПРАВЛЯЮЩАЯ КОМПАНИЯ", OrgItemTypeTyp.PREFIX, "УК", True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ЗАКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "ЗАО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ОБЩЕСТВО ОТКРЫТОГО ТИПА", OrgItemTypeTyp.PREFIX, True, "ООТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ОБЩЕСТВО С ДОПОЛНИТЕЛЬНОЙ ОТВЕТСТВЕННОСТЬЮ", OrgItemTypeTyp.PREFIX, True, "ОДО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2343("РОССИЙСКОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "РАО", "PAO"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("РОССИЙСКОЕ ОТКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "РОАО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("АКЦИОНЕРНОЕ ОБЩЕСТВО ЗАКРЫТОГО ТИПА", OrgItemTypeTyp.PREFIX, True, "АОЗТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("АКЦІОНЕРНЕ ТОВАРИСТВО ЗАКРИТОГО ТИПУ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АТЗТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("АКЦИОНЕРНОЕ ОБЩЕСТВО ОТКРЫТОГО ТИПА", OrgItemTypeTyp.PREFIX, True, "АООТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("АКЦІОНЕРНЕ ТОВАРИСТВО ВІДКРИТОГО ТИПУ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АТВТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, True, "ОО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("ГРОМАДСЬКА ОРГАНІЗАЦІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ГО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("АВТОНОМНАЯ НЕКОММЕРЧЕСКАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, True, "АНО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("АВТОНОМНА НЕКОМЕРЦІЙНА ОРГАНІЗАЦІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АНО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2343("ОТКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "ОАО", "OAO"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ВІДКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ВАТ", "ВАТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2343("ЧАСТНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "ЧАО", "ЧAO"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ОТКРЫТОЕ СТРАХОВОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "ОСАО"))
        t = OrgItemTypeTermin._new2343("ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ", OrgItemTypeTyp.PREFIX, True, "ООО", "OOO")
        t.add_variant("ОБЩЕСТВО C ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ТОВАРИСТВО З ОБМЕЖЕНОЮ ВІДПОВІДАЛЬНІСТЮ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ТОВ", "ТОВ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ТОВАРИСТВО З ПОВНОЮ ВІДПОВІДАЛЬНІСТЮ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ТПВ", "ТПВ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ТОВАРИСТВО З ОБМЕЖЕНОЮ ВІДПОВІДАЛЬНІСТЮ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ТЗОВ", "ТЗОВ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ТОВАРИСТВО З ДОДАТКОВОЮ ВІДПОВІДАЛЬНІСТЮ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ТДВ", "ТДВ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("ЧАСТНОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ПРИВАТНЕ АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ПРАТ", "ПРАТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ПУБЛІЧНЕ АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ПАТ", "ПАТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("ЗАКРЫТОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ЗАКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ЗАТ", "ЗАТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("ОТКРЫТОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2354("ВІДКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ВАТ", "ВАТ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "ПАО"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("СТРАХОВОЕ ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTypeTyp.PREFIX, True, "СПАО"))
        t = OrgItemTypeTermin._new2372("БЛАГОТВОРИТЕЛЬНАЯ ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ", OrgItemTypeTyp.PREFIX, "БОО", "БОО")
        t.add_variant("ОБЩЕСТВЕННАЯ БЛАГОТВОРИТЕЛЬНАЯ ОРГАНИЗАЦИЯ", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2372("ТОВАРИЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ", OrgItemTypeTyp.PREFIX, "ТОО", "TOO"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2223("ПРЕДПРИНИМАТЕЛЬ БЕЗ ОБРАЗОВАНИЯ ЮРИДИЧЕСКОГО ЛИЦА", OrgItemTypeTyp.PREFIX, "ПБОЮЛ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2375("АКЦИОНЕРНЫЙ КОММЕРЧЕСКИЙ БАНК", OrgItemTypeTyp.PREFIX, True, "АКБ", OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2376("АКЦІОНЕРНИЙ КОМЕРЦІЙНИЙ БАНК", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АКБ", OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2375("АКЦИОНЕРНЫЙ БАНК", OrgItemTypeTyp.PREFIX, True, "АБ", OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2376("АКЦІОНЕРНИЙ БАНК", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АБ", OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2379("КОММЕРЧЕСКИЙ БАНК", OrgItemTypeTyp.PREFIX, True, OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2380("КОМЕРЦІЙНИЙ БАНК", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, OrgProfile.FINANCE))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("КОНСТРУКТОРСКОЕ БЮРО", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2382("КОНСТРУКТОРСЬКЕ БЮРО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("ОПЫТНО КОНСТРУКТОРСКОЕ БЮРО", OrgItemTypeTyp.PREFIX, True, "ОКБ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("ДОСЛІДНО КОНСТРУКТОРСЬКЕ БЮРО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "ДКБ"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2331("СПЕЦИАЛЬНОЕ КОНСТРУКТОРСКОЕ БЮРО", OrgItemTypeTyp.PREFIX, "СКБ", True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2386("СПЕЦІАЛЬНЕ КОНСТРУКТОРСЬКЕ БЮРО", MorphLang.UA, OrgItemTypeTyp.PREFIX, "СКБ", True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("АКЦИОНЕРНАЯ СТРАХОВАЯ КОМПАНИЯ", OrgItemTypeTyp.PREFIX, True, "АСК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2335("АКЦІОНЕРНА СТРАХОВА КОМПАНІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, "АСК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2334("РЕКЛАМНО ПРОИЗВОДСТВЕННАЯ КОМПАНИЯ", OrgItemTypeTyp.PREFIX, True, "РПК"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2390("АВТОТРАНСПОРТНОЕ ПРЕДПРИЯТИЕ", OrgItemTypeTyp.PREFIX, True, True, "АТП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2391("АВТОТРАНСПОРТНЕ ПІДПРИЄМСТВО", MorphLang.UA, OrgItemTypeTyp.PREFIX, True, True, "АТП"))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2338("ТЕЛЕРАДИОКОМПАНИЯ", OrgItemTypeTyp.PREFIX, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2382("ТЕЛЕРАДІОКОМПАНІЯ", MorphLang.UA, OrgItemTypeTyp.PREFIX, True))
        t = OrgItemTypeTermin._new2331("ОРГАНИЗОВАННАЯ ПРЕСТУПНАЯ ГРУППИРОВКА", OrgItemTypeTyp.PREFIX, "ОПГ", True)
        t.add_variant("ОРГАНИЗОВАННАЯ ПРЕСТУПНАЯ ГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2331("ОРГАНИЗОВАННОЕ ПРЕСТУПНОЕ СООБЩЕСТВО", OrgItemTypeTyp.PREFIX, "ОПС", True)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ПОДРОСТКОВО МОЛОДЕЖНЫЙ КЛУБ", OrgItemTypeTyp.PREFIX, "ПМК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("СКЛАД ВРЕМЕННОГО ХРАНЕНИЯ", OrgItemTypeTyp.PREFIX, "СВХ", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ЖИЛИЩНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ЖСК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ГСК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ГЭК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ГАРАЖНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ГПК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ПГСК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ГАРАЖНЫЙ СТРОИТЕЛЬНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ГСПК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ДАЧНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ДСК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНЫЙ КООПЕРАТИВ", OrgItemTypeTyp.PREFIX, "ПГК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ИНДИВИДУАЛЬНОЕ ЖИЛИЩНОЕ СТРОИТЕЛЬСТВО", OrgItemTypeTyp.PREFIX, "ИЖС", True, True))
        t = OrgItemTypeTermin._new2396("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, "СНТ", True, True)
        t.add_abridge("САДОВОЕ НЕКОМ-Е ТОВАРИЩЕСТВО")
        t.add_variant("СНТ ПМК", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2396("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", OrgItemTypeTyp.PREFIX, "ДНТ", True, True)
        t.add_abridge("ДАЧНОЕ НЕКОМ-Е ТОВАРИЩЕСТВО")
        t.add_variant("ДНТ ПМК", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2396("ПРЕДПРИЯТИЕ ПОТРЕБИТЕЛЬСКОЙ КООПЕРАЦИИ", OrgItemTypeTyp.PREFIX, "ППК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2410("ПІДПРИЄМСТВО СПОЖИВЧОЇ КООПЕРАЦІЇ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ПСК", True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2411("ФІЗИЧНА ОСОБА ПІДПРИЄМЕЦЬ", MorphLang.UA, OrgItemTypeTyp.PREFIX, "ФОП", True, True))
        t = OrgItemTypeTermin._new2412("ЖЕЛЕЗНАЯ ДОРОГА", OrgItemTypeTyp.ORG, OrgProfile.TRANSPORT, True, 3)
        ...
        for s in ["ЗАВОД", "ФАБРИКА", "БАНК", "КОМБИНАТ", "МЯСОКОМБИНАТ", "БАНКОВСКАЯ ГРУППА", "БИРЖА", "ФОНДОВАЯ БИРЖА", "FACTORY", "MANUFACTORY", "BANK"]: 
            t = OrgItemTypeTermin._new2413(s, 3.5, OrgItemTypeTyp.ORG, True, True)
            OrgItemTypeToken.__m_global.add(t)
        ...
        t = OrgItemTypeTermin._new2414("КРИТПОВАЛЮТНАЯ БИРЖА", 3.5, OrgItemTypeTyp.ORG, OrgProfile.FINANCE, True, True)
        t.add_variant("КРИПТОБИРЖА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2415("КРИПТОВАЛЮТНАЯ БІРЖА", MorphLang.UA, 3.5, OrgItemTypeTyp.ORG, OrgProfile.FINANCE, True, True)
        t.add_variant("КРИПТОБІРЖА", False)
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ЗАВОД", "ФАБРИКА", "БАНК", "КОМБІНАТ", "БАНКІВСЬКА ГРУПА", "БІРЖА", "ФОНДОВА БІРЖА"]: 
            t = OrgItemTypeTermin._new2416(s, MorphLang.UA, 3.5, OrgItemTypeTyp.ORG, True, True)
            OrgItemTypeToken.__m_global.add(t)
        ...
        for s in ["ТУРФИРМА", "ТУРАГЕНТСТВО", "ТУРКОМПАНИЯ", "АВИАКОМПАНИЯ", "КИНОСТУДИЯ", "КООПЕРАТИВ", "РИТЕЙЛЕР", "ОНЛАЙН РИТЕЙЛЕР", "МЕДИАГИГАНТ", "МЕДИАКОМПАНИЯ", "МЕДИАХОЛДИНГ"]: 
            t = OrgItemTypeTermin._new2417(s, 3.5, OrgItemTypeTyp.ORG, True, True, True)
        ...
        for s in ["ТУРФІРМА", "ТУРАГЕНТСТВО", "ТУРКОМПАНІЯ", "АВІАКОМПАНІЯ", "КІНОСТУДІЯ", "КООПЕРАТИВ", "РІТЕЙЛЕР", "ОНЛАЙН-РІТЕЙЛЕР", "МЕДІАГІГАНТ", "МЕДІАКОМПАНІЯ", "МЕДІАХОЛДИНГ"]: 
            t = OrgItemTypeTermin._new2418(s, MorphLang.UA, 3.5, OrgItemTypeTyp.ORG, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ТУРОПЕРАТОР"]: 
            t = OrgItemTypeTermin._new2417(s, 0.5, OrgItemTypeTyp.ORG, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ТУРОПЕРАТОР"]: 
            t = OrgItemTypeTermin._new2418(s, MorphLang.UA, 0.5, OrgItemTypeTyp.ORG, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2421("СБЕРЕГАТЕЛЬНЫЙ БАНК", 4, OrgItemTypeTyp.ORG, True, OrgProfile.FINANCE)
        OrgItemTypeToken.__m_sber_bank = t
        t.add_variant("СБЕРБАНК", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2421("СЛУЖБА БЕЗОПАСНОСТИ", 4, OrgItemTypeTyp.ORG, True, OrgProfile.STATE)
        OrgItemTypeToken.__m_sec_serv = t
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2423("ОЩАДНИЙ БАНК", MorphLang.UA, 4, OrgItemTypeTyp.ORG, True, OrgProfile.FINANCE)
        ...
        for s in ["ОРГАНИЗАЦИЯ", "ПРЕДПРИЯТИЕ", "КОМИТЕТ", "КОМИССИЯ", "ПРОИЗВОДИТЕЛЬ", "ГИГАНТ", "ORGANIZATION", "ENTERPRISE", "COMMITTEE", "COMMISSION", "MANUFACTURER"]: 
            t = OrgItemTypeTermin._new2424(s, OrgItemTypeTyp.ORG, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        ...
        for s in ["СООБЩЕСТВО", "ФОНД", "АССОЦИАЦИЯ", "АЛЬЯНС", "ГИЛЬДИЯ", "ОБЩИНА", "ОБЩЕСТВЕННОЕ ОБЪЕДИНЕНИЕ", "ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ", "ОБЩЕСТВЕННОЕ ФОРМИРОВАНИЕ", "СОЮЗ", "КЛУБ", "ГРУППИРОВКА", "ЛИГА", "COMMUNITY", "FOUNDATION", "ASSOCIATION", "ALLIANCE", "GUILD", "UNION", "CLUB", "GROUP", "LEAGUE"]: 
            t = OrgItemTypeTermin._new2426(s, 3, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.UNION)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ПАРТИЯ", "ДВИЖЕНИЕ", "PARTY", "MOVEMENT"]: 
            t = OrgItemTypeTermin._new2427(s, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.UNION)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["НОЧНОЙ КЛУБ", "NIGHTCLUB"]: 
            t = OrgItemTypeTermin._new2428(s, OrgItemTypeTyp.ORG, True, True, OrgProfile.MUSIC)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ОРГАНІЗАЦІЯ", "ПІДПРИЄМСТВО", "КОМІТЕТ", "КОМІСІЯ", "ВИРОБНИК", "ГІГАНТ", "СУСПІЛЬСТВО", "СПІЛЬНОТА", "ФОНД", "СЛУЖБА", "АСОЦІАЦІЯ", "АЛЬЯНС", "АСАМБЛЕЯ", "ГІЛЬДІЯ", "ОБЄДНАННЯ", "СОЮЗ", "ПАРТІЯ", "РУХ", "ФЕДЕРАЦІЯ", "КЛУБ", "ГРУПУВАННЯ"]: 
            t = OrgItemTypeTermin._new2429(s, MorphLang.UA, OrgItemTypeTyp.ORG, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2430("ДЕПУТАТСКАЯ ГРУППА", OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("ГРУППА ДЕПУТАТОВ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2431("ДЕПУТАТСЬКА ГРУПА", MorphLang.UA, OrgItemTypeTyp.ORG, 3, True)
        ...
        for s in ["ФОНД", "СОЮЗ", "ОБЪЕДИНЕНИЕ", "ОРГАНИЗАЦИЯ", "ФЕДЕРАЦИЯ", "ДВИЖЕНИЕ"]: 
            for ss in ["ВСЕМИРНЫЙ", "МЕЖДУНАРОДНЫЙ", "ВСЕРОССИЙСКИЙ", "ОБЩЕСТВЕННЫЙ", "НЕКОММЕРЧЕСКИЙ", "ЕВРОПЕЙСКИЙ", "ВСЕУКРАИНСКИЙ"]: 
                t = OrgItemTypeTermin._new2413("{0} {1}".format(ss, s), 3.5, OrgItemTypeTyp.ORG, True, True)
        ...
        for s in ["ФОНД", "СОЮЗ", "ОБЄДНАННЯ", "ОРГАНІЗАЦІЯ", "ФЕДЕРАЦІЯ", "РУХ"]: 
            for ss in ["СВІТОВИЙ", "МІЖНАРОДНИЙ", "ВСЕРОСІЙСЬКИЙ", "ГРОМАДСЬКИЙ", "НЕКОМЕРЦІЙНИЙ", "ЄВРОПЕЙСЬКИЙ", "ВСЕУКРАЇНСЬКИЙ"]: 
                t = OrgItemTypeTermin._new2416("{0} {1}".format(ss, s), MorphLang.UA, 3.5, OrgItemTypeTyp.ORG, True, True)
                bi = None
                try: 
                    bi = MorphologyService.get_word_base_info(s, MorphLang.UA, False, False)
                except Exception as ex2434: 
                    pass
                if (bi is not None and bi.gender != MorphGender.MASCULINE): 
                    adj = None
                    try: 
                        adj = MorphologyService.get_wordform(ss, MorphBaseInfo._new849(MorphClass.ADJECTIVE, bi.gender, MorphNumber.SINGULAR, MorphLang.UA))
                        if (adj is not None): 
                            t.canonic_text = "{0} {1}".format(adj, s)
                    except Exception as ex2436: 
                        pass
                if (s == "ОРГАНІЗАЦІЯ" or s == "ФЕДЕРАЦІЯ"): 
                    t.coeff = (3)
                OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2413("ИНВЕСТИЦИОННЫЙ ФОНД", 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ИНВЕСТФОНД", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2416("ІНВЕСТИЦІЙНИЙ ФОНД", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ІНВЕСТФОНД", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2413("СОЦИАЛЬНАЯ СЕТЬ", 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("СОЦСЕТЬ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2416("СОЦІАЛЬНА МЕРЕЖА", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("СОЦМЕРЕЖА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2413("ОФФШОРНАЯ КОМПАНИЯ", 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ОФФШОР", False)
        t.add_variant("ОФШОР", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2416("ОФШОРНА КОМПАНІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True)
        t.add_variant("ОФШОР", False)
        OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2443("ТЕРРОРИСТИЧЕСКАЯ ОРГАНИЗАЦИЯ", 3, OrgItemTypeTyp.ORG, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2444("ТЕРОРИСТИЧНА ОРГАНІЗАЦІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2445("АТОМНАЯ ЭЛЕКТРОСТАНЦИЯ", 3, OrgItemTypeTyp.ORG, "АЭС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2446("АТОМНА ЕЛЕКТРОСТАНЦІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, "АЕС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2445("ГИДРОЭЛЕКТРОСТАНЦИЯ", 3, OrgItemTypeTyp.ORG, "ГЭС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2446("ГІДРОЕЛЕКТРОСТАНЦІЯ", MorphLang.UA, 3, OrgItemTypeTyp.ORG, "ГЕС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2445("ГИДРОРЕЦИРКУЛЯЦИОННАЯ ЭЛЕКТРОСТАНЦИЯ", 3, OrgItemTypeTyp.ORG, "ГРЭС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2445("ТЕПЛОВАЯ ЭЛЕКТРОСТАНЦИЯ", 3, OrgItemTypeTyp.ORG, "ТЭС", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2445("НЕФТЕПЕРЕРАБАТЫВАЮЩИЙ ЗАВОД", 3, OrgItemTypeTyp.ORG, "НПЗ", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2446("НАФТОПЕРЕРОБНИЙ ЗАВОД", MorphLang.UA, 3, OrgItemTypeTyp.ORG, "НПЗ", True, True, True))
        for s in ["ФИРМА", "ТРЕСТ", "КОМПАНИЯ", "КОРПОРАЦИЯ", "ГОСКОРПОРАЦИЯ", "КОНЦЕРН", "КОНСОРЦИУМ", "ХОЛДИНГ", "МЕДИАХОЛДИНГ", "ТОРГОВЫЙ ДОМ", "ТОРГОВЫЙ ЦЕНТР", "ТОРГОВО РАЗВЛЕКАТЕЛЬНЫЙ ЦЕНТР", "УЧЕБНЫЙ ЦЕНТР", "ИССЛЕДОВАТЕЛЬСКИЙ ЦЕНТР", "КОСМИЧЕСКИЙ ЦЕНТР", "ДЕЛОВОЙ ЦЕНТР", "БИЗНЕС ЦЕНТР", "БИЗНЕС ПАРК", "АУКЦИОННЫЙ ДОМ", "ИЗДАТЕЛЬСТВО", "ИЗДАТЕЛЬСКИЙ ДОМ", "ТОРГОВЫЙ КОМПЛЕКС", "ТОРГОВО РАЗВЛЕКАТЕЛЬНЫЙ КОМПЛЕКС", "ТОРГОВО ОФИСНЫЙ КОМПЛЕКС", "ТОРГОВО ОФИСНЫЙ ЦЕНТР", "СПОРТИВНЫЙ КОМПЛЕКС", "СПОРТИВНО РАЗВЛЕКАТЕЛЬНЫЙ КОМПЛЕКС", "СПОРТИВНО ОЗДОРОВИТЕЛЬНЫЙ КОМПЛЕКС", "ФИЗКУЛЬТУРНО ОЗДОРОВИТЕЛЬНЫЙ КОМПЛЕКС", "АГЕНТСТВО НЕДВИЖИМОСТИ", "ГРУППА КОМПАНИЙ", "МЕДИАГРУППА", "МАГАЗИН", "ТОРГОВЫЙ КОМПЛЕКС", "ГИПЕРМАРКЕТ", "СУПЕРМАРКЕТ", "КАФЕ", "РЕСТОРАН", "БАР", "ТРАКТИР", "ТАВЕРНА", "СТОЛОВАЯ", "АУКЦИОН", "АНАЛИТИЧЕСКИЙ ЦЕНТР", "COMPANY", "CORPORATION"]: 
            t = OrgItemTypeTermin._new2453(s, 3, OrgItemTypeTyp.ORG, True, True, True)
            if (s == "ИЗДАТЕЛЬСТВО"): 
        ...
        for s in ["ФІРМА", "ТРЕСТ", "КОМПАНІЯ", "КОРПОРАЦІЯ", "ДЕРЖКОРПОРАЦІЯ", "КОНЦЕРН", "КОНСОРЦІУМ", "ХОЛДИНГ", "МЕДІАХОЛДИНГ", "ТОРГОВИЙ ДІМ", "ТОРГОВИЙ ЦЕНТР", "ТОРГОВО РОЗВАЖАЛЬНИЙ ЦЕНТР", "НАВЧАЛЬНИЙ ЦЕНТР", "ДІЛОВИЙ ЦЕНТР", " БІЗНЕС ЦЕНТР", "ВИДАВНИЦТВО", "ВИДАВНИЧИЙ ДІМ", "ТОРГОВИЙ КОМПЛЕКС", "ТОРГОВО РОЗВАЖАЛЬНИЙ КОМПЛЕКС", "СПОРТИВНИЙ КОМПЛЕКС", "СПОРТИВНО РОЗВАЖАЛЬНИЙ КОМПЛЕКС", "СПОРТИВНО ОЗДОРОВЧИЙ КОМПЛЕКС", "ФІЗКУЛЬТУРНО ОЗДОРОВЧИЙ КОМПЛЕКС", "АГЕНТСТВО НЕРУХОМОСТІ", "ГРУПА КОМПАНІЙ", "МЕДІАГРУПА", "МАГАЗИН", "ТОРГОВИЙ КОМПЛЕКС", "ГІПЕРМАРКЕТ", "СУПЕРМАРКЕТ", "КАФЕ", "БАР", "АУКЦІОН", "АНАЛІТИЧНИЙ ЦЕНТР"]: 
            t = OrgItemTypeTermin._new2454(s, MorphLang.UA, OrgItemTypeTyp.ORG, True, True, True)
            if (s == "ВИДАВНИЦТВО"): 
            ...
            if (s.startswith("МЕДІА")): 
                t.profiles.append(OrgProfile.MEDIA)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2455("ЭКОЛОГИЧЕСКАЯ ГРУППА", MorphLang.RU, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("ЭКОГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("РОК ГРУППА", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("РОКГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("ПАНК ГРУППА", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("ПАНКГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("ОРКЕСТР", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("ХОР", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("МУЗЫКАЛЬНЫЙ КОЛЛЕКТИВ", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("РОКГРУППА", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("РОК ГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("ПАНКГРУППА", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("ПАНК ГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("АРТГРУППА", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        t.add_variant("АРТ ГРУППА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2464("ВОКАЛЬНО ИНСТРУМЕНТАЛЬНЫЙ АНСАМБЛЬ", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True, "ВИА")
        t.add_variant("ИНСТРУМЕНТАЛЬНЫЙ АНСАМБЛЬ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("НАРОДНЫЙ АНСАМБЛЬ", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 3, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("АНСАМБЛЬ", MorphLang.RU, OrgProfile.MUSIC, OrgItemTypeTyp.ORG, 1, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2456("СТУДИЯ", MorphLang.RU, OrgProfile.CULTURE, OrgItemTypeTyp.ORG, 1, True)
        OrgItemTypeToken.__m_global.add(t)
        for s in ["НОТАРИАЛЬНАЯ КОНТОРА", "АДВОКАТСКОЕ БЮРО", "СТРАХОВОЕ ОБЩЕСТВО", "ЮРИДИЧЕСКИЙ ДОМ"]: 
            t = OrgItemTypeTermin._new2468(s, OrgItemTypeTyp.ORG, True, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["НОТАРІАЛЬНА КОНТОРА", "АДВОКАТСЬКЕ БЮРО", "СТРАХОВЕ ТОВАРИСТВО"]: 
            t = OrgItemTypeTermin._new2469(s, MorphLang.UA, OrgItemTypeTyp.ORG, True, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ГАЗЕТА", "ЕЖЕНЕДЕЛЬНИК", "ТАБЛОИД", "ЕЖЕНЕДЕЛЬНЫЙ ЖУРНАЛ", "NEWSPAPER", "WEEKLY", "TABLOID", "MAGAZINE"]: 
            t = OrgItemTypeTermin._new2470(s, 3, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.MEDIA)
            t.profiles.append(OrgProfile.PRESS)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ГАЗЕТА", "ТИЖНЕВИК", "ТАБЛОЇД"]: 
            t = OrgItemTypeTermin._new2471(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True, OrgProfile.MEDIA)
            t.profiles.append(OrgProfile.PRESS)
            OrgItemTypeToken.__m_global.add(t)
        ...
        for s in ["ПАНСІОНАТ", "САНАТОРІЙ", "БУДИНОК ВІДПОЧИНКУ", "ГОТЕЛЬ", "SPA-ГОТЕЛЬ", "ОЗДОРОВЧИЙ ТАБІР", "БАЗА ВІДПОЧИНКУ", "СПОРТ-КЛУБ", "ФІТНЕС-КЛУБ"]: 
            t = OrgItemTypeTermin._new2475(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True)
            if (s == "САНАТОРІЙ"): 
                t.add_abridge("САН.")
            OrgItemTypeToken.__m_global.add(t)
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2476("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", 3, OrgItemTypeTyp.ORG, "ДОЛ", True, True, True))
        OrgItemTypeToken.__m_global.add(OrgItemTypeTermin._new2476("ДЕТСКИЙ СПОРТИВНЫЙ ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", 3, OrgItemTypeTyp.ORG, "ДСОЛ", True, True, True))
        for s in ["САДОВО ОГОРОДНОЕ ТОВАРИЩЕСТВО", "КООПЕРАТИВ", "ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "КРЕСТЬЯНСКО ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "АГРОФИРМА", "АГРОСОЮЗ", "КОНЕЗАВОД", "ПТИЦЕФЕРМА", "СВИНОФЕРМА", "ФЕРМА", "ЛЕСПРОМХОЗ", "ЖИВОТНОВОДЧЕСКАЯ ТОЧКА"]: 
            t = OrgItemTypeTermin._new2478(s, 3, OrgItemTypeTyp.ORG, True, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2479("СЕМЕНОВОДЧЕСКАЯ АГРОФИРМА", 3, "САФ", OrgItemTypeTyp.ORG, True, True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("КОЛХОЗ", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        ...
        for s in ["КОЛГОСП", "САДОВО ГОРОДНЄ ТОВАРИСТВО", "КООПЕРАТИВ", "ФЕРМЕРСЬКЕ ГОСПОДАРСТВО", "СЕЛЯНСЬКО ФЕРМЕРСЬКЕ ГОСПОДАРСТВО", "АГРОФІРМА", "КОНЕЗАВОД", "ПТАХОФЕРМА", "СВИНОФЕРМА", "ФЕРМА"]: 
            t = OrgItemTypeTermin._new2481(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True, True)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2445("ЖИЛИЩНО КОММУНАЛЬНОЕ ХОЗЯЙСТВО", 3, OrgItemTypeTyp.ORG, "ЖКХ", True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2445("ЖИТЛОВО КОМУНАЛЬНЕ ГОСПОДАРСТВО", 3, OrgItemTypeTyp.ORG, "ЖКГ", True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2484("КОММУНАЛЬНОЕ ПРЕДПРИЯТИЕ", 3, OrgItemTypeTyp.ORG, True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2485("КОМУНАЛЬНЕ ПІДПРИЄМСТВО", MorphLang.UA, 3, OrgItemTypeTyp.ORG, True, True, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("АВТОМОБИЛЬНЫЙ ЗАВОД", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_variant("АВТОЗАВОД", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("АВТОМОБИЛЬНЫЙ ЦЕНТР", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_variant("АВТОЦЕНТР", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2453("ЭКОЛОГИЧЕСКИЙ ЦЕНТР", 3, OrgItemTypeTyp.ORG, True, True, True)
        t.add_variant("ЭКОЦЕНТР", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("СОВХОЗ", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_abridge("С/Х")
        t.add_abridge("С-З")
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("ПЛЕМЕННОЕ ХОЗЯЙСТВО", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_variant("ПЛЕМХОЗ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("ЛЕСНОЕ ХОЗЯЙСТВО", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_variant("ЛЕСХОЗ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2484("ЛЕСНИЧЕСТВО", 3, OrgItemTypeTyp.ORG, True, True, True)
        ...
        while i < len(sads): 
            ...
            t = OrgItemTypeTermin._new2493(parts[0], 3, sads[i + 1], OrgItemTypeTyp.ORG, True, True, True)
            j = 1
            while j < len(parts): 
            ...
            OrgItemTypeToken.__m_global.add(t)
            i += 2
        t = OrgItemTypeTermin._new2494("САДОВОДЧЕСКАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", "СПК", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        ...
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        ...
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("САДОВОДЧЕСКИЙ КООПЕРАТИВ", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_abridge("САДОВОДЧ.КООП.")
        t.add_abridge("САДОВ.КООП.")
        t.add_variant("САДОВЫЙ КООПЕРАТИВ", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2478("ДАЧНОЕ ТОВАРИЩЕСТВО", 3, OrgItemTypeTyp.ORG, True, True, True, True)
        t.add_abridge("ДАЧН.ТОВ.")
        t.add_abridge("ДАЧ.ТОВ.")
        OrgItemTypeToken.__m_global.add(t)
        for s in ["ФЕСТИВАЛЬ", "ЧЕМПИОНАТ", "ОЛИМПИАДА", "КОНКУРС"]: 
            t = OrgItemTypeTermin._new1977(s, 3, OrgItemTypeTyp.ORG, True)
            OrgItemTypeToken.__m_global.add(t)
        for s in ["ФЕСТИВАЛЬ", "ЧЕМПІОНАТ", "ОЛІМПІАДА"]: 
            t = OrgItemTypeTermin._new2499(s, MorphLang.UA, 3, OrgItemTypeTyp.ORG, True)
            OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2500("ПОГРАНИЧНЫЙ ПОСТ", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY)
        t.add_variant("ПОГП", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2500("ПОГРАНИЧНАЯ ЗАСТАВА", 3, OrgItemTypeTyp.ORG, True, True, OrgProfile.ARMY)
        t.add_variant("ПОГЗ", False)
        t.add_variant("ПОГРАНЗАСТАВА", False)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("ТЕРРИТОРИАЛЬНЫЙ ПУНКТ", 3, OrgItemTypeTyp.DEP, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2081("МИГРАЦИОННЫЙ ПУНКТ", 3, OrgItemTypeTyp.DEP, True)
        OrgItemTypeToken.__m_global.add(t)
        t = OrgItemTypeTermin._new2504("ПРОПУСКНОЙ ПУНКТ", 3, True, OrgItemTypeTyp.DEP, True, True)
        ...
        for s in ["КАПІТАЛ", "КЕРІВНИЦТВО", "ЗЇЗД", "ЗБОРИ", "РАДА", "УПРАВЛІННЯ"]: 
            OrgItemTypeToken._m_pref_words.add(Termin._new1616(s, MorphLang.UA))
        for s in ["АКЦИЯ", "ВЛАДЕЛЕЦ", "ВЛАДЕЛИЦА", "СОВЛАДЕЛЕЦ", "СОВЛАДЕЛИЦА", "КОНКУРЕНТ"]: 
            OrgItemTypeToken._m_pref_words.add(Termin._new123(s, s))
        for s in ["АКЦІЯ", "ВЛАСНИК", "ВЛАСНИЦЯ", "СПІВВЛАСНИК", "СПІВВЛАСНИЦЯ", "КОНКУРЕНТ"]: 
            OrgItemTypeToken._m_pref_words.add(Termin._new319(s, s, MorphLang.UA))
        for k in range(3):
            ...
            with MemoryStream(OrgItemTypeToken._deflate(dat)) as tmp: 
                ...
                for x in xml0_.getroot(): 
                    if (k == 0): 
                        OrgItemTypeToken._m_pref_words.add(Termin._new123(Utils.getXmlInnerText(x), 1))
                    elif (k == 1): 
                        OrgItemTypeToken._m_pref_words.add(Termin._new319(Utils.getXmlInnerText(x), 1, MorphLang.UA))
                    elif (k == 2): 
                        OrgItemTypeToken._m_pref_words.add(Termin._new319(Utils.getXmlInnerText(x), 1, MorphLang.EN))
        ...
        for s in ["ЧАСТЬ", "БАНК", "ЗАВОД", "ФАБРИКА", "АЭРОПОРТ", "БИРЖА", "СЛУЖБА", "МИНИСТЕРСТВО", "КОМИССИЯ", "КОМИТЕТ", "ГРУППА", "ЧАСТИНА", "БАНК", "ЗАВОД", "ФАБРИКА", "АЕРОПОРТ", "БІРЖА", "СЛУЖБА", "МІНІСТЕРСТВО", "КОМІСІЯ", "КОМІТЕТ", "ГРУПА"]: 
            OrgItemTypeToken._m_key_words_for_refs.add(Termin._new123(s, s))
        ...
        for s in ["РОССИЙСКИЙ", "ВСЕРОССИЙСКИЙ", "МЕЖДУНАРОДНЫЙ", "ВСЕМИРНЫЙ", "ЕВРОПЕЙСКИЙ", "ГОСУДАРСТВЕННЫЙ", "НЕГОСУДАРСТВЕННЫЙ", "ФЕДЕРАЛЬНЫЙ", "РЕГИОНАЛЬНЫЙ", "ОБЛАСТНОЙ", "ГОРОДСКОЙ", "МУНИЦИПАЛЬНЫЙ", "АВТОНОМНЫЙ", "НАЦИОНАЛЬНЫЙ", "МЕЖРАЙОННЫЙ", "РАЙОННЫЙ", "ОТРАСЛЕВОЙ", "МЕЖОТРАСЛЕВОЙ", "МЕЖРЕГИОНАЛЬНЫЙ", "НАРОДНЫЙ", "ВЕРХОВНЫЙ", "УКРАИНСКИЙ", "ВСЕУКРАИНСКИЙ", "РУССКИЙ"]: 
            OrgItemTypeToken.__m_std_adjs.add(Termin._new744(s, MorphLang.RU, s))
        ...
        for s in ["РОСІЙСЬКИЙ", "ВСЕРОСІЙСЬКИЙ", "МІЖНАРОДНИЙ", "СВІТОВИЙ", "ЄВРОПЕЙСЬКИЙ", "ДЕРЖАВНИЙ", "НЕДЕРЖАВНИЙ", "ФЕДЕРАЛЬНИЙ", "РЕГІОНАЛЬНИЙ", "ОБЛАСНИЙ", "МІСЬКИЙ", "МУНІЦИПАЛЬНИЙ", "АВТОНОМНИЙ", "НАЦІОНАЛЬНИЙ", "МІЖРАЙОННИЙ", "РАЙОННИЙ", "ГАЛУЗЕВИЙ", "МІЖГАЛУЗЕВИЙ", "МІЖРЕГІОНАЛЬНИЙ", "НАРОДНИЙ", "ВЕРХОВНИЙ", "УКРАЇНСЬКИЙ", "ВСЕУКРАЇНСЬКИЙ", "РОСІЙСЬКА"]: 
            OrgItemTypeToken.__m_std_adjsua.add(Termin._new744(s, MorphLang.UA, s))
    ...
    @staticmethod
    def _new1927(_arg1 : 'Token', _arg2 : 'Token', _arg3 : float) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.__m_coef = _arg3
        return res
    
    @staticmethod
    def _new1928(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : str, _arg5 : float) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.name = _arg4
        res.coef = _arg5
    ...
    @staticmethod
    def _new1931(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'OrgItemTypeTermin', _arg5 : bool) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.root = _arg4
    ...
    @staticmethod
    def _new1933(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1935(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'OrgItemTypeTermin') -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.root = _arg4
        return res
    ...
    @staticmethod
    def _new1939(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : str, _arg5 : float, _arg6 : 'OrgItemTypeTermin') -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.name = _arg4
        res.coef = _arg5
    ...
    @staticmethod
    def _new1940(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'OrgItemTypeTermin', _arg5 : bool) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.root = _arg4
    ...
    @staticmethod
    def _new1941(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : str, _arg5 : 'OrgItemTypeTermin', _arg6 : bool) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.alt_typ = _arg4
        res.root = _arg5
    ...
    @staticmethod
    def _new1942(_arg1 : 'Token', _arg2 : 'Token', _arg3 : float, _arg4 : bool, _arg5 : str) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.coef = _arg3
    ...
    @staticmethod
    def _new1944(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'OrgItemTypeTermin', _arg4 : str) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.root = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new1948(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : float, _arg5 : bool) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
        res.coef = _arg4
        res.is_dep = _arg5
    ...
    @staticmethod
    def _new1950(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : bool, _arg5 : 'OrgItemTypeTermin', _arg6 : str) -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new1952(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'MorphCollection', _arg5 : 'CharsInfo', _arg6 : 'CharsInfo') -> 'OrgItemTypeToken':
        res = OrgItemTypeToken(_arg1, _arg2)
        res.name = _arg3
        res.morph = _arg4
        res.chars = _arg5
