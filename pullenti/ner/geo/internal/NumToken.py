...
class NumToken(MetaToken):
    ...
    def try_parse(t : 'Token', typ : 'GeoTokenType') -> 'NumToken':
        ...
        if (tt is not None): 
            ...
            while True:
                ...
                if (not (isinstance(ttt, NumberToken))): 
                    break
                res = NumToken._new1322(t, ttt, True, "n")
                res.value = ttt.value
                res.__correct(typ)
                return res
        if (tt is None): 
        ...
        if ((isinstance(tt, TextToken)) and not t.is_value("C", None)): 
            ...
            if (nt is not None and nt.value != "100"): 
                res = NumToken._new1322(t, nt.end_token, tt != t, "l")
                res.value = nt.value
                res.__correct(typ)
                return res
        ...
        if (((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter) and typ == GeoTokenType.STRONG): 
            res = NumToken._new1322(t, t, tt != t, "c")
    ...
    @staticmethod
    def _new1322(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool, _arg4 : str) -> 'NumToken':
    ...
    @staticmethod
    def _new1324(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'NumToken':
        res = NumToken(_arg1, _arg2)
        res.has_prefix = _arg3
        return res