...
class OrgTypToken(MetaToken):
    ...
    def __try_parse(t : 'Token', after_terr : bool, lev : int=0) -> 'OrgTypToken':
        ...
        if ((tok is None and after_terr and (isinstance(t, TextToken))) and t.term == "СТ"): 
            tok = TerminToken._new766(t, t, OrgTypToken.__m_st)
        if (tok is not None): 
        ...
        if (morph_ is None): 
            morph_ = t1.morph
        res = OrgTypToken._new1332(t, t1, doubt, typs, morph_, notorg, notgeo, canbesingle, building)
    ...
    def initialize() -> None:
        ...
        t = Termin._new1320("САДОВОЕ ТОВАРИЩЕСТВО", "СТ")
        ...
        t = Termin._new1284("ДАЧНОЕ ТОВАРИЩЕСТВО", "ДТ", True)
        t.add_abridge("Д/Т")
        t.add_abridge("ДАЧ/Т")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ЖИЛИЩНОЕ ТОВАРИЩЕСТВО", "ЖТ", True)
        t.add_abridge("Ж/Т")
        t.add_abridge("ЖИЛ/Т")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("САДОВЫЙ КООПЕРАТИВ", "СК", True)
        t.add_variant("САДОВОДЧЕСКИЙ КООПЕРАТИВ", False)
        t.add_abridge("С/К")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ПК", True)
        t.add_variant("ПОТРЕБКООПЕРАТИВ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ПОТРЕБИТЕЛЬСКИЙ САДОВОДЧЕСКИЙ КООПЕРАТИВ")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("САДОВОЕ ОБЩЕСТВО", "СО", True)
        t.add_variant("САДОВОДЧЕСКОЕ ОБЩЕСТВО", False)
        t.add_variant("САДОВОДСТВО", False)
        t.add_abridge("С/О")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ПОТРЕБИТЕЛЬСКОЕ САДОВОДЧЕСКОЕ ОБЩЕСТВО", "ПСО", True)
        t.add_variant("ПОТРЕБИТЕЛЬСКОЕ САДОВОЕ ОБЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("САДОВОЕ ТОВАРИЩЕСКОЕ ОБЩЕСТВО", "СТО", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("САДОВОЕ ПОТРЕБИТЕЛЬСКОЕ ОБЩЕСТВО", "СПО", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ ДАЧНОЕ ТОВАРИЩЕСТВО", "СДТ", True, True)
        t.add_variant("САДОВОЕ ДАЧНОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "ДНО", True, True)
        t.add_variant("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ ГРАЖДАН", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "ДНП", True, True)
        t.add_variant("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО ГРАЖДАН", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "ДНТ", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ДАЧНЫЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ")
        t.acronym = "ДПК"
        t.acronym_can_be_lower = True
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ДАЧНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ДСК", True, True)
        t.add_variant("ДАЧНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "СПК", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ВОДНО МОТОРНЫЙ КООПЕРАТИВ", "ВМК", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "СНТ", True, True)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "СНО", True, True)
        t.add_variant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВО ОГОРОДНОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "СОНО", True, True)
        t.add_variant("САДОВО ОГОРОДНОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ ГРАЖДАН", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "СНП", True, True)
        t.add_variant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКИЙ НЕКОММЕРЧЕСКИЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "СНПК", True, True)
        t.add_variant("САДОВЫЙ НЕКОММЕРЧЕСКИЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "СНТ", True, True)
        t.add_variant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКОЕ ОГОРОДНИЧЕСКОЕ ТОВАРИЩЕСТВО", "СОТ", True, True)
        t.add_variant("САДОВОЕ ОГОРОДНИЧЕСКОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ДАЧНОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "ДНТ", True, True)
        t.add_variant("ДАЧНО НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "НСТ", True, True)
        t.add_variant("НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНСТ", True, True)
        t.add_variant("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("САДОВОДЧЕСКАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", "СПК", True, True)
        ...
        t.add_variant("ДАЧНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", False)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1343("ДАЧНО СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ДСПК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ЖИЛИЩНЫЙ СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ЖСПК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ЖИЛИЩНЫЙ СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ЖСПКИЗ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ЖСК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ЖСКИЗ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ЖИЛИЩНОЕ СТРОИТЕЛЬНОЕ ТОВАРИЩЕСТВО", "ЖСТ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ПОТРЕБИТЕЛЬСКОЕ ОБЩЕСТВО ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ПОТЗ", True, True))
        t = Termin._new1343("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "ОНО", True, True)
        t.add_variant("ОГОРОДНИЧЕСКОЕ ОБЪЕДИНЕНИЕ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "ОНП", True, True)
        t.add_variant("ОГОРОДНИЧЕСКОЕ ПАРТНЕРСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНТ", True, True)
        t.add_variant("ОГОРОДНИЧЕСКОЕ ТОВАРИЩЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ОГОРОДНИЧЕСКИЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ОПК", True, True)
        t.add_variant("ОГОРОДНИЧЕСКИЙ КООПЕРАТИВ", False)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1343("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СТСН", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "ТСН", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО ЧАСТНЫХ ВЛАДЕЛЬЦЕВ", "СТЧВ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ ЖИЛЬЯ", "ТСЖ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ ЖИЛЬЯ КЛУБНОГО ПОСЕЛКА", "ТСЖКП", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("САДОВЫЕ ЗЕМЕЛЬНЫЕ УЧАСТКИ", "СЗУ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1343("ТОВАРИЩЕСТВО ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ТИЗ", True, True))
        t = Termin._new1343("КОЛЛЕКТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "КИЗ", True, True)
        t.add_variant("КИЗК", False)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1343("ОБЩЕСТВО ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ ГАРАЖЕЙ", "ОИЗГ", True, True))
        t = Termin._new1343("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СНТСН", True, True)
        t.add_variant("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", False)
        t.add_variant("СНТ СН", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ПОТРЕБИТЕЛЬСКОЕ ГАРАЖНО СТРОИТЕЛЬНОЕ ОБЩЕСТВО", "ПГСО", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ПОТРЕБИТЕЛЬСКОЕ КООПЕРАТИВНОЕ ОБЩЕСТВО ГАРАЖЕЙ", "ПКОГ", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО ГАРАЖНЫЙ КООПЕРАТИВ", "НПГК", True, True)
        t.add_abridge("НП ГК")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО СОБСТВЕННИКОВ", "НПС", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("СУБЪЕКТ МАЛОГО ПРЕДПРИНИМАТЕЛЬСТВА", "СМП", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1343("ЛИЧНОЕ ПОДСОБНОЕ ХОЗЯЙСТВО", "ЛПХ", True, True)
        t.add_variant("ПОДХОЗ", False)
        t.add_abridge("ПОД.ХОЗ.")
        t.add_abridge("П/Х")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ИНДИВИДУАЛЬНОЕ САДОВОДСТВО", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КОЛЛЕКТИВНЫЙ ГАРАЖ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КОМПЛЕКС ГАРАЖЕЙ", 1)
        t.add_variant("РАЙОН ГАРАЖЕЙ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГАРАЖНЫЙ МАССИВ", 1)
        t.add_variant("ГАРАЖНЫЙ УЧАСТОК", False)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПЛОЩАДКА ГАРАЖЕЙ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КОЛЛЕКТИВНЫЙ САД", 1)
        t.add_abridge("КОЛ.САД")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("САД", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КОМПЛЕКС ЗДАНИЙ И СООРУЖЕНИЙ", 1)
        t.add_variant("КОМПЛЕКС СТРОЕНИЙ И СООРУЖЕНИЙ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ОБЪЕДИНЕНИЕ")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПРОМЫШЛЕННАЯ ПЛОЩАДКА", 1)
        t.add_variant("ПРОМПЛОЩАДКА", False)
        t.add_abridge("ПРОМ.ПЛОЩАДКА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПРОИЗВОДСТВЕННАЯ ПЛОЩАДКА", 1)
        t.add_abridge("ПРОИЗВ.ПЛОЩАДКА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ИМУЩЕСТВЕННЫЙ КОМПЛЕКС", 1)
        OrgTypToken._m_ontology.add(t)
        ...
        t.acronym_can_be_lower = True
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ГАРАЖНОЕ ОБЩЕСТВО", "ГО", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПЛОЩАДКА ГАРАЖЕЙ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГАРАЖНЫЙ КОМПЛЕКС", 1)
        OrgTypToken._m_ontology.add(t)
        ...
        t.acronym_can_be_lower = True
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1341("ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ГСК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ГАРАЖНО САРАЙНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ГССК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", "ГЭК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ГАРАЖНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГПК", True, True))
        t = Termin._new1341("КООПЕРАТИВ ПО СТРОИТЕЛЬСТВУ И ЭКСПЛУАТАЦИИ ГАРАЖЕЙ", "КСЭГ", True, True)
        t.add_variant("КСИЭГ", False)
        t.add_variant("КССГ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("ГАРАЖНЫЙ ЭКСПЛУАТАЦИОННО-СТРОИТЕЛЬНЫЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГЭСПК", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("КООПЕРАТИВ ПО СТРОИТЕЛЬСТВУ ГАРАЖЕЙ", "КСГ", True, True)
        t.add_variant("КССГ", False)
        OrgTypToken._m_ontology.add(t)
        ...
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1341("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ПГСК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", "ПГЭК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ОБЩЕСТВЕННО ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНЫЙ КООПЕРАТИВ", "ОПГК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ГАРАЖНЫЙ СТРОИТЕЛЬНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГСПК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("КООПЕРАТИВ ПО СТРОИТЕЛЬСТВУ И ЭКСПЛУАТАЦИИ ИНДИВИДУАЛЬНЫХ ГАРАЖЕЙ", "КСЭИГ", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНЫЙ КООПЕРАТИВ", "ПГК", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ПОТРЕБИТЕЛЬСКОЕ ГАРАЖНОЕ ОБЩЕСТВО", "ПГО", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ИНДИВИДУАЛЬНОЕ ЖИЛИЩНОЕ СТРОИТЕЛЬСТВО", "ИЖС", True, True))
        OrgTypToken._m_ontology.add(Termin._new1341("ИНДИВИДУАЛЬНЫЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ИГСК", True, True))
        OrgTypToken._m_ontology.add(Termin("ЖИВОТНОВОДЧЕСКАЯ ТОЧКА"))
        t = Termin._new1419("ДАЧНАЯ ЗАСТРОЙКА", "ДЗ", True, 1)
        t.add_variant("КВАРТАЛ ДАЧНОЙ ЗАСТРОЙКИ", False)
        t.add_variant("ЗОНА ДАЧНОЙ ЗАСТРОЙКИ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1420("КОТТЕДЖНЫЙ ПОСЕЛОК", "КП", True, 1, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1420("ДАЧНЫЙ ПОСЕЛОК", "ДП", True, 1, 1)
        t.add_abridge("Д/П")
        t.add_variant("ДАЧНЫЙ ПОСЕЛОК МАССИВ", False)
        t.add_variant("ДП МАССИВ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1422("САДОВОДЧЕСКИЙ МАССИВ", 1, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ДЕТСКИЙ ГОРОДОК", 1)
        t.add_abridge("ДЕТ.ГОРОДОК")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1320("ДОМ ОТДЫХА", "ДО")
        t.add_abridge("Д/О")
        OrgTypToken._m_ontology.add(t)
        t = Termin("МЕСТО ОТДЫХА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("БАЗА ОТДЫХА", "БО", True)
        t.add_abridge("Б/О")
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ТУРИСТИЧЕСКАЯ БАЗА", "ТБ", True)
        t.add_abridge("Т/Б")
        t.add_variant("ТУРБАЗА", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ПАКР ОТЕЛЬ")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "ФХ", True, True)
        t.add_abridge("Ф/Х")
        t.add_abridge("ФЕРМЕРСКОЕ Х-ВО")
        t.add_abridge("ФЕРМЕРСКОЕ ХОЗ-ВО")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("КРЕСТЬЯНСКОЕ ХОЗЯЙСТВО", "КХ", True, True)
        t.add_abridge("К/Х")
        t.add_abridge("КРЕСТЬЯНСКОЕ Х-ВО")
        t.add_abridge("КРЕСТЬЯНСКОЕ ХОЗ-ВО")
        t.add_abridge("КР.Х-ВО")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("КРЕСТЬЯНСКОЕ ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "КФХ", True, True)
        t.add_variant("КРЕСТЬЯНСКОЕ (ФЕРМЕРСКОЕ) ХОЗЯЙСТВО", False)
        t.add_abridge("К.Ф.Х.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("САД-ОГОРОД", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("ОВЦЕВОДЧЕСКАЯ ТОВАРНАЯ ФЕРМА", "ОТФ", True, True)
        OrgTypToken._m_ontology.add(t)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("УЧЕБНОЕ ХОЗЯЙСТВО", "УХ", True)
        t.add_abridge("У/Х")
        ...
        t.add_abridge("З-ДА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("НЕФТЕПЕРЕРАБАТЫВАЮЩИЙ ЗАВОД", "НПЗ", True, True)
        t.add_variant("НЕФТЕ ПЕРЕРАБАТЫВАЮЩИЙ ЗАВОД", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("ГАЗОПЕРЕРАБАТЫВАЮЩИЙ ЗАВОД", "ГПЗ", True, True)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("СЕЛЬСКОХОЗЯЙСТВЕННАЯ ЗЕМЛЯ", 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", "ОЛ", True)
        t.add_abridge("О/Л")
        t.add_abridge("О.Л.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ ЛАГЕРЬ", "ООЛ", True)
        t.add_abridge("О/Л")
        t.add_abridge("О.Л.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", "ДОЛ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ СПОРТИВНЫЙ ЛАГЕРЬ", "ДСЛ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ ЛАГЕРЬ", "ДООЛ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНЫЙ КОМПЛЕКС", "ДОК", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ КОМПЛЕКС", "ДООК", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ ЦЕНТР", "ДООЦ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ ПРОФИЛЬНЫЙ ЦЕНТР", "ДООПЦ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНО ОБРАЗОВАТЕЛЬНЫЙ СПОРТИВНЫЙ ЦЕНТР", "ДООСЦ", True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ОЗДОРОВИТЕЛЬНЫЙ КОМПЛЕКС", "ОК", True)
        t.add_abridge("О/К")
        t.add_abridge("О.К.")
        OrgTypToken._m_ontology.add(t)
        ...
        t = Termin("КУРОРТ")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("КОЛЛЕКТИВ ИНДИВИДУАЛЬНЫХ ВЛАДЕЛЬЦЕВ", "КИВ", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ПОДСОБНОЕ ХОЗЯЙСТВО")
        t.add_abridge("ПОДСОБНОЕ Х-ВО")
        t.add_abridge("ПОДСОБНОЕ ХОЗ-ВО")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("АЭРОПОРТ", 1)
        t.add_abridge("А/П")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("АЭРОДРОМ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГИДРОУЗЕЛ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГИДРОТЕХНИЧЕСКИЙ КОМПЛЕКС", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ВОДОЗАБОР", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ВОДОХРАНИЛИЩЕ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("МОРСКОЙ ПОРТ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("РЕЧНОЙ ПОРТ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("СКЛАД", 1)
        t.add_variant("ЦЕНТРАЛЬНЫЙ СКЛАД", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ОВОЩЕХРАНИЛИЩЕ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("СВИНОКОМПЛЕКС", 1)
        t.add_variant("СВИНОВОДЧЕСКИЙ КОМПЛЕКС", False)
        t.add_variant("СВИНОКОМПЛЕКС СК", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПОЛЕ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПОЛЕВОЙ СТАН", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГУРТ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КОШАРА", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЧАБАНСКАЯ СТОЯНКА", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЛИЦЕНЗИОННЫЙ УЧАСТОК", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("УРОЧИЩЕ", 1)
        t.add_abridge("УР-ЩЕ")
        t.add_abridge("УР.")
        t.add_abridge("УРОЧ.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПАДЬ", 1)
        t.add_variant("ПЯДЬ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПАРК", 1)
        t.add_variant("ПРИРОДНЫЙ ПАРК", False)
        t.add_variant("НАЦИОНАЛЬНЫЙ ПАРК", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1468("ПАРК КУЛЬТУРЫ И ОТДЫХА", "ПКО", 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЗАИМКА", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("МЫС", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("БЕРЕГ РЕКИ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ОСТРОВ", 1)
        t.add_abridge("О-В")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ИСТОРИЧЕСКИЙ РАЙОН", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("СВАЛКА БЫТОВЫХ ОТХОДОВ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin("МУЗЕЙ")
        t.add_variant("МУЗЕЙ УСАДЬБА", False)
        t.add_variant("МУЗЕЙ ЗАПОВЕДНИК", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("КЛАДБИЩЕ", 1)
        t.add_abridge("КЛ-ЩЕ")
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1320("СТРОИТЕЛЬНО МОНТАЖНОЕ УПРАВЛЕНИЕ", "СМУ")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ВОЙСКОВАЯ ЧАСТЬ", "ВЧ", True)
        t.add_variant("ВОИНСКАЯ ЧАСТЬ", False)
        t.add_abridge("В/Ч")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("ПОЖАРНАЯ ЧАСТЬ", "ПЧ", True)
        t.add_abridge("ПОЖ. ЧАСТЬ")
        t.add_abridge("П/Ч")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1422("ВОЕННЫЙ ГОРОДОК", 1, 1)
        t.add_abridge("В.ГОРОДОК")
        t.add_abridge("В/Г")
        t.add_abridge("В/ГОРОДОК")
        t.add_abridge("В/ГОР")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("СТРОИТЕЛЬНОЕ УПРАВЛЕНИЕ", "СУ", True)
        t.add_abridge("С/У")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("МЕСТЕЧКО", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1422("ГОРОДОК", 1, 1)
        t.add_variant("ВАГОН ГОРОДОК", False)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1483("МІСТЕЧКО", MorphLang.UA, 1, MorphGender.NEUTER, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1422("HILL", 1, 1)
        t.add_abridge("HL.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1284("КВАРТИРНО ЭКСПЛУАТАЦИОННАЯ ЧАСТЬ", "КЭЧ", True)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1389("КАРЬЕР", 1))
        OrgTypToken._m_ontology.add(Termin._new1389("РУДНИК", 1))
        OrgTypToken._m_ontology.add(Termin._new1389("ПРИИСК", 1))
        OrgTypToken._m_ontology.add(Termin._new1389("РАЗРЕЗ", 1))
        OrgTypToken._m_ontology.add(Termin._new1389("ФАКТОРИЯ", 1))
        t = Termin._new1389("МЕСТОРОЖДЕНИЕ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЛОКАЛЬНОЕ ПОДНЯТИЕ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("НЕФТЯНОЕ МЕСТОРОЖДЕНИЕ", 1)
        t.add_variant("МЕСТОРОЖДЕНИЕ НЕФТИ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1494("ГАЗОВОЕ МЕСТОРОЖДЕНИЕ", "ГМ", True, True, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1494("НЕФТЕГАЗОВОЕ МЕСТОРОЖДЕНИЕ", "НГМ", True, True, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1494("НЕФТЕГАЗОКОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", "НГКМ", True, True, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1494("ГАЗОВОНЕФТЕКОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", "ГНКМ", True, True, 1)
        t.add_variant("ГАЗОВО НЕФТЕ КОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1494("ГАЗОКОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", "ГКМ", True, True, 1)
        t.add_variant("ГАЗОВОЕ КОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", False)
        t.add_variant("ГАЗОВОКОНДЕНСАТНОЕ МЕСТОРОЖДЕНИЕ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("НЕФТЕПЕРЕКАЧИВАЮЩАЯ СТАНЦИЯ", 1)
        OrgTypToken._m_ontology.add(t)
        OrgTypToken._m_ontology.add(Termin._new1389("ЛЕСНОЙ ТЕРМИНАЛ", 1))
        OrgTypToken._m_ontology.add(Termin._new1389("МОЛОЧНЫЙ КОМПЛЕКС", 1))
        t = Termin._new1389("МЕСТОРОЖДЕНИЕ", 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("МЕСТНОСТЬ", StreetItemType.NOUN, MorphGender.FEMINIE, 1)
        t.add_abridge("МЕСТН.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЛЕСНИЧЕСТВО", 1)
        t.add_abridge("ЛЕС-ВО")
        t.add_abridge("ЛЕСН-ВО")
        t.add_variant("УЧАСТКОВОЕ ЛЕСНИЧЕСТВО", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЛЕСОПАРК", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЛЕСОУЧАСТОК", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЗАПОВЕДНИК", 1)
        t.add_abridge("ЗАП-К")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЦЕНТРАЛЬНАЯ УСАДЬБА", 1)
        ...
        t.add_abridge("Ц/О")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("СЕКТОР", 1)
        t.add_abridge("СЕК.")
        t.add_abridge("СЕКТ.")
        t.add_abridge("С-Р")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("МАССИВ", StreetItemType.NOUN, MorphGender.MASCULINE, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("ЗОНА", StreetItemType.NOUN, MorphGender.FEMINIE, 1)
        t.add_variant("ЗОНА (МАССИВ)", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("ЗОНА ГАРАЖЕЙ", StreetItemType.NOUN, MorphGender.FEMINIE, 1)
        t.add_variant("ЗОНА (МАССИВ) ГАРАЖЕЙ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ГАРАЖНАЯ ПЛОЩАДКА", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПОЛЕВОЙ МАССИВ", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ПОЛЕВОЙ УЧАСТОК", 1)
        t.add_abridge("ПОЛЕВОЙ УЧ-К")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("ПРОМЗОНА", StreetItemType.NOUN, MorphGender.FEMINIE, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1503("ПРОМУЗЕЛ", StreetItemType.NOUN, MorphGender.MASCULINE, 1)
        t.add_variant("ПРОМЫШЛЕННЫЙ УЗЕЛ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ПРОМЫШЛЕННЫЙ РАЙОН", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_variant("ПРОМРАЙОН", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ПЛАНИРОВОЧНЫЙ РАЙОН", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_abridge("П/Р")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ПРОИЗВОДСТВЕННО АДМИНИСТРАТИВНАЯ ЗОНА", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_abridge("ПРОИЗВ. АДМ. ЗОНА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ЖИЛАЯ ЗОНА", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_variant("ЖИЛЗОНА", False)
        t.add_variant("ЖИЛ.ЗОНА", False)
        t.add_variant("Ж.ЗОНА", False)
        t.add_abridge("Ж/З")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1522("ОСОБАЯ ЭКОНОМИЧЕСКАЯ ЗОНА", "ОЭЗ", True, True, 1, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ЗОНА ОТДЫХА", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_abridge("З/О")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("КОММУНАЛЬНАЯ ЗОНА", StreetItemType.NOUN, 1, MorphGender.FEMINIE, 1)
        t.add_variant("КОМЗОНА", False)
        t.add_abridge("КОММУН. ЗОНА")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ЖИЛОЙ МАССИВ", StreetItemType.NOUN, 1, MorphGender.MASCULINE, 1)
        t.add_abridge("Ж.М.")
        t.add_abridge("Ж/М")
        t.add_variant("ЖИЛМАССИВ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1422("ЖИЛГОРОДОК", 1, 1)
        t.add_variant("ЖИЛИЩНЫЙ ГОРОДОК", False)
        t.add_variant("ЖИЛОЙ ГОРОДОК", False)
        t.add_abridge("Ж/Г")
        t.add_abridge("ЖИЛ.ГОР.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЖИЛРАЙОН", 1)
        ...
        t.add_abridge("Ж/Р-Н")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1389("ЗАГОРОДНЫЙ КОМПЛЕКС", 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1518("ИНДУСТРИАЛЬНЫЙ ПАРК", StreetItemType.NOUN, 1, MorphGender.MASCULINE, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1530("КВАРТАЛ ДАЧНОЙ ЗАСТРОЙКИ", "КВАРТАЛ", StreetItemType.NOUN, 0, MorphGender.MASCULINE, 1)
        t.add_variant("ПРОМЫШЛЕННЫЙ КВАРТАЛ", False)
        t.add_variant("ИНДУСТРИАЛЬНЫЙ КВАРТАЛ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1531("ЖИЛОЙ КОМПЛЕКС", StreetItemType.NOUN, "ЖК", 0, MorphGender.MASCULINE, 1)
        ...
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1531("ВАХТОВЫЙ ЖИЛОЙ КОМПЛЕКС", StreetItemType.NOUN, "ВЖК", 0, MorphGender.MASCULINE, 1)
        OrgTypToken._m_ontology.add(t)
        t = Termin("ТЕЛЕВЕЩАНИЕ")
        t.add_variant("ТЕЛЕВИЗИОННОЕ ВЕЩАНИЕ", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1533("ИСПРАВИТЕЛЬНАЯ КОЛОНИЯ", StreetItemType.NOUN, "ИК", 0)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1533("ИСПРАВИТЕЛЬНО ТРУДОВАЯ КОЛОНИЯ", StreetItemType.NOUN, "ИТК", 0)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1533("ДЕТСКАЯ ТРУДОВАЯ КОЛОНИЯ", StreetItemType.NOUN, "ДТК", 0)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1533("ЛЕЧЕБНО ТРУДОВОЙ ПРОФИЛАКТОРИЙ", StreetItemType.NOUN, "ЛТП", 0)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1537("ВАСИЛЬЕВСКИЙ ОСТРОВ", StreetItemType.STDNAME, "ВО", 1)
        t.add_abridge("В.О.")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new325("ПЕТРОГРАДСКАЯ СТОРОНА", StreetItemType.STDNAME, 1)
        t.add_abridge("П.С.")
        OrgTypToken._m_ontology.add(t)
        for s in ["АПТЕКА", "АТЕЛЬЕ", "ОТЕЛЬ", "ГОСТИНИЦА", "ХОСТЕЛ", "СТУДИЯ", "ПАРИКМАХЕРСКАЯ", "СТОЛОВАЯ", "КАФЕ", "РЕСТОРАН", "УНИВЕРМАГ", "УНИВЕРСАМ", "СУПЕРМАРКЕТ"]: 
            OrgTypToken._m_ontology.add(Termin._new123(s, AddressItemType.BUILDING))
        t = Termin._new123("МАГАЗИН", AddressItemType.BUILDING)
        t.add_abridge("МАГ.")
        t.add_abridge("МАГ-Н")
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1341("БИЗНЕС ЦЕНТР", "БЦ", True, True)
        t.add_variant("БІЗНЕС ЦЕНТР", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1542("ТОРГОВЫЙ ЦЕНТР", AddressItemType.BUILDING, "ТЦ", True, True)
        t.add_variant("ТОРГОВИЙ ЦЕНТР", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1542("ТОРГОВО ОФИСНЫЙ ЦЕНТР", AddressItemType.BUILDING, "ТОЦ", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1542("ТОРГОВО ОФИСНЫЙ КОМПЛЕКС", AddressItemType.BUILDING, "ТОК", True, True)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1542("ТОРГОВО РАЗВЛЕКАТЕЛЬНЫЙ ЦЕНТР", AddressItemType.BUILDING, "ТРЦ", True, True)
        t.add_variant("ТОРГОВО РОЗВАЖАЛЬНИЙ ЦЕНТР", False)
        OrgTypToken._m_ontology.add(t)
        t = Termin._new1542("ТОРГОВО РАЗВЛЕКАТЕЛЬНЫЙ КОМПЛЕКС", AddressItemType.BUILDING, "ТРК", True, True)
    ...
    @staticmethod
    def _new1332(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool, _arg4 : typing.List[str], _arg5 : 'MorphCollection', _arg6 : bool, _arg7 : bool, _arg8 : bool, _arg9 : bool) -> 'OrgTypToken':
