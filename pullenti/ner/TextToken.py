...
class TextToken(Token):
    ...
    def check_value(self, dict0_ : typing.List[tuple]) -> object:
        ...
        if (dict0_ is None): 
            return None
        res = None
        wrapres3056 = RefOutArgWrapper(None)
        inoutres3057 = Utils.tryGetValue(dict0_, self.term, wrapres3056)
        res = wrapres3056.value
        if (inoutres3057): 
            return res
            ...
            for it in self.morph.items: 
                ...
                if (mf is not None): 
                    if (mf.normal_case is not None): 
                        wrapres3052 = RefOutArgWrapper(None)
                        inoutres3053 = Utils.tryGetValue(dict0_, mf.normal_case, wrapres3052)
                        res = wrapres3052.value
                        if (inoutres3053): 
                            return res
                    if (mf.normal_full is not None and mf.normal_case != mf.normal_full): 
                        wrapres3054 = RefOutArgWrapper(None)
                        inoutres3055 = Utils.tryGetValue(dict0_, mf.normal_full, wrapres3054)
    ...
    def get_normal_case_text(self, mc : 'MorphClass'=None, num : 'MorphNumber'=MorphNumber.UNDEFINED, gender : 'MorphGender'=MorphGender.UNDEFINED, keep_chars : bool=False) -> str:
        ...
        if (num == MorphNumber.SINGULAR and mc is not None): 
            bi = MorphBaseInfo._new849(MorphClass._new284(mc.value), gender, MorphNumber.SINGULAR, self.morph.language)
            vars0_ = None
            try: 
    ...
    @staticmethod
    def _new827(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.term0 = _arg5
        return res
    
    @staticmethod
    def _new830(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : 'CharsInfo', _arg6 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.chars = _arg5
        res.term0 = _arg6
        return res