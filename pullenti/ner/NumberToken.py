...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn3029 = RefOutArgWrapper(0)
        inoutres3030 = Utils.tryParseInt(self.__m_value, wrapn3029)
        n = wrapn3029.value
        if (inoutres3030): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new869(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
