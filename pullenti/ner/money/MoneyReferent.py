...
class MoneyReferent(Referent):
    ...
    def value(self) -> float:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1845 = RefOutArgWrapper(0)
        inoutres1846 = Utils.tryParseFloat(val, wrapv1845)
        v = wrapv1845.value
        if (not inoutres1846): 
            return 0
        return v
    ...
    def alt_value(self) -> float:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1847 = RefOutArgWrapper(0)
        inoutres1848 = Utils.tryParseFloat(val, wrapv1847)
        v = wrapv1847.value
        if (not inoutres1848): 
            return None
        return v
    ...
    def rest(self) -> int:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1849 = RefOutArgWrapper(0)
        inoutres1850 = Utils.tryParseInt(val, wrapv1849)
        v = wrapv1849.value
        if (not inoutres1850): 
            return 0
        return v
    ...
    def alt_rest(self) -> int:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1851 = RefOutArgWrapper(0)
        inoutres1852 = Utils.tryParseInt(val, wrapv1851)
        v = wrapv1851.value
        if (not inoutres1852): 
            return None
        return v
