    ...
    def process(self, names : typing.List[str], typ : str) -> None:
        ...
        while True:
            ...
            if (name.find('/') > 0): 
                ar = None
                try: 
                    ar = ProcessorService.get_empty_processor().process(SourceOfAnalysis._new128(name, "GARADDRESS"), None, None)
            ...
            for k in range(1):
                ...
                ar = None
                try: 
                    ar = ProcessorService.get_standard_processor().process(SourceOfAnalysis._new128(txt, "GARADDRESS"), None, None)
