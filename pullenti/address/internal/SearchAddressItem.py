...
class SearchAddressItem(object):
    ...
    @staticmethod
    def _new86(_arg1 : 'SearchLevel', _arg2 : str) -> 'SearchAddressItem':
    ...
    @staticmethod
    def _new96(_arg1 : str, _arg2 : 'SearchLevel', _arg3 : object, _arg4 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.level = _arg2
        res.tag = _arg3
    ...
    @staticmethod
    def _new98(_arg1 : str, _arg2 : object, _arg3 : 'SearchLevel', _arg4 : 'SearchAddressItem', _arg5 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.tag = _arg2
        res.level = _arg3
    ...
    @staticmethod
    def _new100(_arg1 : str, _arg2 : object, _arg3 : 'SearchLevel', _arg4 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.tag = _arg2
        res.level = _arg3
